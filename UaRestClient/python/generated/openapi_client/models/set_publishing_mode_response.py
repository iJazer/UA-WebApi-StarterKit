...
class SetPublishingModeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetPublishingModeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetPublishingModeResponse:
        """Create an instance of SetPublishingModeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetPublishingModeResponse.parse_obj(obj)

        _obj = SetPublishingModeResponse.parse_obj({
