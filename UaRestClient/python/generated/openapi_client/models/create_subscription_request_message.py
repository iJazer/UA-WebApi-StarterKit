...
class CreateSubscriptionRequestMessage(BaseModel):
    """
    ...
    body: CreateSubscriptionRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 785):
            raise ValueError("must be one of enum values (0, 785)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSubscriptionRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSubscriptionRequestMessage:
        """Create an instance of CreateSubscriptionRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSubscriptionRequestMessage.parse_obj(obj)

        _obj = CreateSubscriptionRequestMessage.parse_obj({
            ...
            "body": CreateSubscriptionRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
