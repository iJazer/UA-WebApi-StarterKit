...
class DeleteMonitoredItemsRequestMessage(BaseModel):
    """
    ...
    body: DeleteMonitoredItemsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 779):
            raise ValueError("must be one of enum values (0, 779)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteMonitoredItemsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteMonitoredItemsRequestMessage:
        """Create an instance of DeleteMonitoredItemsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteMonitoredItemsRequestMessage.parse_obj(obj)

        _obj = DeleteMonitoredItemsRequestMessage.parse_obj({
            ...
            "body": DeleteMonitoredItemsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
