...
class DeleteMonitoredItemsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteMonitoredItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteMonitoredItemsResponse:
        """Create an instance of DeleteMonitoredItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteMonitoredItemsResponse.parse_obj(obj)

        _obj = DeleteMonitoredItemsResponse.parse_obj({
