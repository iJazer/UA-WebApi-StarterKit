...
class BrowseRequestMessage(BaseModel):
    """
    ...
    body: BrowseRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 525):
            raise ValueError("must be one of enum values (0, 525)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrowseRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrowseRequestMessage:
        """Create an instance of BrowseRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrowseRequestMessage.parse_obj(obj)

        _obj = BrowseRequestMessage.parse_obj({
            ...
            "body": BrowseRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
