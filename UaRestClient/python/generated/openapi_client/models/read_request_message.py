...
class ReadRequestMessage(BaseModel):
    """
    ReadRequestMessage
    """
    ...
    body: ReadRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 629):
            raise ValueError("must be one of enum values (0, 629)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReadRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReadRequestMessage:
        """Create an instance of ReadRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReadRequestMessage.parse_obj(obj)

        _obj = ReadRequestMessage.parse_obj({
            ...
            "body": ReadRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
