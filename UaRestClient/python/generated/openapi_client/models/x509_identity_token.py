...
class X509IdentityToken(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> X509IdentityToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> X509IdentityToken:
        """Create an instance of X509IdentityToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return X509IdentityToken.parse_obj(obj)

        _obj = X509IdentityToken.parse_obj({
