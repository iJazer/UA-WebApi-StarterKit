...
class TranslateBrowsePathsToNodeIdsRequestMessage(BaseModel):
    """
    ...
    body: TranslateBrowsePathsToNodeIdsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 552):
            raise ValueError("must be one of enum values (0, 552)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TranslateBrowsePathsToNodeIdsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TranslateBrowsePathsToNodeIdsRequestMessage:
        """Create an instance of TranslateBrowsePathsToNodeIdsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TranslateBrowsePathsToNodeIdsRequestMessage.parse_obj(obj)

        _obj = TranslateBrowsePathsToNodeIdsRequestMessage.parse_obj({
            ...
            "body": TranslateBrowsePathsToNodeIdsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
