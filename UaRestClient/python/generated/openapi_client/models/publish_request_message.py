...
class PublishRequestMessage(BaseModel):
    """
    ...
    body: PublishRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 824):
            raise ValueError("must be one of enum values (0, 824)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublishRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublishRequestMessage:
        """Create an instance of PublishRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublishRequestMessage.parse_obj(obj)

        _obj = PublishRequestMessage.parse_obj({
            ...
            "body": PublishRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
