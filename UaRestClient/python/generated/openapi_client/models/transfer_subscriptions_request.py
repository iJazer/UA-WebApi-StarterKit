...
class TransferSubscriptionsRequest(BaseModel):
    ...
    send_initial_values: Optional[StrictBool] = Field(None, alias="SendInitialValues")
    __properties = ["RequestHeader", "SubscriptionIds", "SendInitialValues"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferSubscriptionsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferSubscriptionsRequest:
        """Create an instance of TransferSubscriptionsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferSubscriptionsRequest.parse_obj(obj)

        _obj = TransferSubscriptionsRequest.parse_obj({
            ...
            "send_initial_values": obj.get("SendInitialValues")
        })
        return _obj
