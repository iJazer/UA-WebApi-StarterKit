...
class Decimal(BaseModel):
    ...
    Decimal
    """
    scale: Optional[conint(strict=True, le=32767, ge=-32768)] = Field(None, alias="Scale")
    value: Optional[StrictStr] = Field(None, alias="Value")
    __properties = ["Scale", "Value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Decimal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Decimal:
        """Create an instance of Decimal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Decimal.parse_obj(obj)

        _obj = Decimal.parse_obj({
            "scale": obj.get("Scale"),
            "value": obj.get("Value")
        })
        return _obj
