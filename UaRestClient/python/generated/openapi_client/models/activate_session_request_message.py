...
class ActivateSessionRequestMessage(BaseModel):
    """
    ...
    body: ActivateSessionRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 465):
            raise ValueError("must be one of enum values (0, 465)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateSessionRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateSessionRequestMessage:
        """Create an instance of ActivateSessionRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateSessionRequestMessage.parse_obj(obj)

        _obj = ActivateSessionRequestMessage.parse_obj({
            ...
            "body": ActivateSessionRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
