...
class IssuedIdentityToken(BaseModel):
    ...
    IssuedIdentityToken
    """
    token_data: Optional[Union[StrictBytes, StrictStr]] = Field(None, alias="TokenData")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssuedIdentityToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssuedIdentityToken:
        """Create an instance of IssuedIdentityToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssuedIdentityToken.parse_obj(obj)

        _obj = IssuedIdentityToken.parse_obj({
