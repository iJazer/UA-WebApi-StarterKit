...
class DeleteSubscriptionsRequestMessage(BaseModel):
    """
    ...
    body: DeleteSubscriptionsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 845):
            raise ValueError("must be one of enum values (0, 845)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteSubscriptionsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteSubscriptionsRequestMessage:
        """Create an instance of DeleteSubscriptionsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteSubscriptionsRequestMessage.parse_obj(obj)

        _obj = DeleteSubscriptionsRequestMessage.parse_obj({
            ...
            "body": DeleteSubscriptionsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
