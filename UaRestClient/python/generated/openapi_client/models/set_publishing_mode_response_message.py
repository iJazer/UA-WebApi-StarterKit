...
class SetPublishingModeResponseMessage(BaseModel):
    """
    ...
    body: Optional[SetPublishingModeResponse] = Field(None, alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 800, 395):
            raise ValueError("must be one of enum values (0, 800, 395)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetPublishingModeResponseMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetPublishingModeResponseMessage:
        """Create an instance of SetPublishingModeResponseMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetPublishingModeResponseMessage.parse_obj(obj)

        _obj = SetPublishingModeResponseMessage.parse_obj({
            "namespace_uris": obj.get("NamespaceUris"),
            "server_uris": obj.get("ServerUris"),
            "service_id": obj.get("ServiceId"),
            "body": SetPublishingModeResponse.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
