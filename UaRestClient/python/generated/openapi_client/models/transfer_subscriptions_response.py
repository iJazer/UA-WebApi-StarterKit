...
class TransferSubscriptionsResponse(BaseModel):
    ...
    results: Optional[conlist(TransferResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferSubscriptionsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferSubscriptionsResponse:
        """Create an instance of TransferSubscriptionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferSubscriptionsResponse.parse_obj(obj)

        _obj = TransferSubscriptionsResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [TransferResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
