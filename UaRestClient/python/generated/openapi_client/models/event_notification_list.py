...
class EventNotificationList(BaseModel):
    ...
    """
    events: Optional[conlist(EventFieldList)] = Field(None, alias="Events")
    __properties = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventNotificationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventNotificationList:
        """Create an instance of EventNotificationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventNotificationList.parse_obj(obj)

        _obj = EventNotificationList.parse_obj({
        })
        return _obj
