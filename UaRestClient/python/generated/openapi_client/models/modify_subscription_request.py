...
class ModifySubscriptionRequest(BaseModel):
    ...
    __properties = ["RequestHeader", "SubscriptionId", "RequestedPublishingInterval", "RequestedLifetimeCount", "RequestedMaxKeepAliveCount", "MaxNotificationsPerPublish", "Priority"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifySubscriptionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifySubscriptionRequest:
        """Create an instance of ModifySubscriptionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifySubscriptionRequest.parse_obj(obj)

        _obj = ModifySubscriptionRequest.parse_obj({
