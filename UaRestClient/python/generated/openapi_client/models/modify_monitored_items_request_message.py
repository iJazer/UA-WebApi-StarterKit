...
class ModifyMonitoredItemsRequestMessage(BaseModel):
    """
    ...
    body: ModifyMonitoredItemsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 761):
            raise ValueError("must be one of enum values (0, 761)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyMonitoredItemsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyMonitoredItemsRequestMessage:
        """Create an instance of ModifyMonitoredItemsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifyMonitoredItemsRequestMessage.parse_obj(obj)

        _obj = ModifyMonitoredItemsRequestMessage.parse_obj({
            ...
            "body": ModifyMonitoredItemsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
