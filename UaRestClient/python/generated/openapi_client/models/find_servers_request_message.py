...
class FindServersRequestMessage(BaseModel):
    """
    ...
    body: FindServersRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 420):
            raise ValueError("must be one of enum values (0, 420)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FindServersRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FindServersRequestMessage:
        """Create an instance of FindServersRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FindServersRequestMessage.parse_obj(obj)

        _obj = FindServersRequestMessage.parse_obj({
            ...
            "body": FindServersRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
