...
class HistoryUpdateResponse(BaseModel):
    ...
    results: Optional[conlist(HistoryUpdateResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HistoryUpdateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HistoryUpdateResponse:
        """Create an instance of HistoryUpdateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HistoryUpdateResponse.parse_obj(obj)

        _obj = HistoryUpdateResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [HistoryUpdateResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
