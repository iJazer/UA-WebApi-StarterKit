...
class CallRequestMessage(BaseModel):
    ...
    body: CallRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 710):
            raise ValueError("must be one of enum values (0, 710)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CallRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CallRequestMessage:
        """Create an instance of CallRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CallRequestMessage.parse_obj(obj)

        _obj = CallRequestMessage.parse_obj({
            ...
            "body": CallRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
