...
class HistoryUpdateResult(BaseModel):
    ...
    operation_results: Optional[conlist(conint(strict=True, le=4294967295, ge=0))] = Field(None, alias="OperationResults")
    diagnostic_infos: Optional[conlist(DiagnosticInfo)] = Field(None, alias="DiagnosticInfos")
    __properties = ["StatusCode", "OperationResults", "DiagnosticInfos"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HistoryUpdateResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HistoryUpdateResult:
        """Create an instance of HistoryUpdateResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HistoryUpdateResult.parse_obj(obj)

        _obj = HistoryUpdateResult.parse_obj({
            "status_code": obj.get("StatusCode"),
            "operation_results": obj.get("OperationResults"),
