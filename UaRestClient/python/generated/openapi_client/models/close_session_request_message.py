...
class CloseSessionRequestMessage(BaseModel):
    """
    ...
    body: CloseSessionRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 471):
            raise ValueError("must be one of enum values (0, 471)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloseSessionRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloseSessionRequestMessage:
        """Create an instance of CloseSessionRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloseSessionRequestMessage.parse_obj(obj)

        _obj = CloseSessionRequestMessage.parse_obj({
            ...
            "body": CloseSessionRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
