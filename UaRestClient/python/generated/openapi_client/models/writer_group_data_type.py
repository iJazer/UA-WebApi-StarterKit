...
class WriterGroupDataType(BaseModel):
    ...
    publishing_interval: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="PublishingInterval")
    keep_alive_time: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="KeepAliveTime")
    ...
    data_set_writers: Optional[conlist(DataSetWriterDataType)] = Field(None, alias="DataSetWriters")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WriterGroupDataType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WriterGroupDataType:
        """Create an instance of WriterGroupDataType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WriterGroupDataType.parse_obj(obj)

        _obj = WriterGroupDataType.parse_obj({
            "name": obj.get("Name"),
