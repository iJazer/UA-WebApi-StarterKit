...
class RepublishRequestMessage(BaseModel):
    """
    ...
    body: RepublishRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 830):
            raise ValueError("must be one of enum values (0, 830)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepublishRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepublishRequestMessage:
        """Create an instance of RepublishRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepublishRequestMessage.parse_obj(obj)

        _obj = RepublishRequestMessage.parse_obj({
            ...
            "body": RepublishRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
