...
class CreateMonitoredItemsRequestMessage(BaseModel):
    """
    ...
    body: CreateMonitoredItemsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 749):
            raise ValueError("must be one of enum values (0, 749)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMonitoredItemsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMonitoredItemsRequestMessage:
        """Create an instance of CreateMonitoredItemsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMonitoredItemsRequestMessage.parse_obj(obj)

        _obj = CreateMonitoredItemsRequestMessage.parse_obj({
            ...
            "body": CreateMonitoredItemsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
