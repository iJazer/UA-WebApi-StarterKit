...
class CloseSessionRequest(BaseModel):
    ...
    delete_subscriptions: Optional[StrictBool] = Field(None, alias="DeleteSubscriptions")
    __properties = ["RequestHeader", "DeleteSubscriptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CloseSessionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CloseSessionRequest:
        """Create an instance of CloseSessionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CloseSessionRequest.parse_obj(obj)

        _obj = CloseSessionRequest.parse_obj({
            "request_header": RequestHeader.from_dict(obj.get("RequestHeader")) if obj.get("RequestHeader") is not None else None,
            "delete_subscriptions": obj.get("DeleteSubscriptions")
        })
        return _obj
