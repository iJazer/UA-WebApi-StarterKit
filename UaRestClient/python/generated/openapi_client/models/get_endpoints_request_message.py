...
class GetEndpointsRequestMessage(BaseModel):
    """
    ...
    body: GetEndpointsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 426):
            raise ValueError("must be one of enum values (0, 426)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEndpointsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEndpointsRequestMessage:
        """Create an instance of GetEndpointsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetEndpointsRequestMessage.parse_obj(obj)

        _obj = GetEndpointsRequestMessage.parse_obj({
            ...
            "body": GetEndpointsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
