...
class MonitoredItemNotification(BaseModel):
    ...
    __properties = ["ClientHandle", "Value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonitoredItemNotification:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonitoredItemNotification:
        """Create an instance of MonitoredItemNotification from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonitoredItemNotification.parse_obj(obj)

        _obj = MonitoredItemNotification.parse_obj({
