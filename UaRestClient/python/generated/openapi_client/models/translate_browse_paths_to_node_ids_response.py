...
class TranslateBrowsePathsToNodeIdsResponse(BaseModel):
    """
    TranslateBrowsePathsToNodeIdsResponse
    """
    response_header: Optional[ResponseHeader] = Field(None, alias="ResponseHeader")
    results: Optional[conlist(BrowsePathResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TranslateBrowsePathsToNodeIdsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TranslateBrowsePathsToNodeIdsResponse:
        """Create an instance of TranslateBrowsePathsToNodeIdsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TranslateBrowsePathsToNodeIdsResponse.parse_obj(obj)

        _obj = TranslateBrowsePathsToNodeIdsResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [BrowsePathResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
