...
class CancelRequestMessage(BaseModel):
    ...
    body: CancelRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 477):
            raise ValueError("must be one of enum values (0, 477)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelRequestMessage:
        """Create an instance of CancelRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelRequestMessage.parse_obj(obj)

        _obj = CancelRequestMessage.parse_obj({
            ...
            "body": CancelRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
