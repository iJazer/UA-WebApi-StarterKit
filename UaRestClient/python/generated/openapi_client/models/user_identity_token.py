...
class UserIdentityToken(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserIdentityToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserIdentityToken:
        """Create an instance of UserIdentityToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserIdentityToken.parse_obj(obj)

        _obj = UserIdentityToken.parse_obj({
