...
class AttributeOperand(BaseModel):
    ...
    browse_path: Optional[RelativePath] = Field(None, alias="BrowsePath")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOperand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOperand:
        """Create an instance of AttributeOperand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeOperand.parse_obj(obj)

        _obj = AttributeOperand.parse_obj({
        })
        return _obj
