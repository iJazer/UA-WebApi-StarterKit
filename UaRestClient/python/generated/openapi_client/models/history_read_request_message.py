...
class HistoryReadRequestMessage(BaseModel):
    """
    ...
    body: HistoryReadRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 662):
            raise ValueError("must be one of enum values (0, 662)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HistoryReadRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HistoryReadRequestMessage:
        """Create an instance of HistoryReadRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HistoryReadRequestMessage.parse_obj(obj)

        _obj = HistoryReadRequestMessage.parse_obj({
            ...
            "body": HistoryReadRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
