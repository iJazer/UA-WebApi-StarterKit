...
class CreateSessionRequestMessage(BaseModel):
    """
    ...
    body: CreateSessionRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 459):
            raise ValueError("must be one of enum values (0, 459)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSessionRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSessionRequestMessage:
        """Create an instance of CreateSessionRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSessionRequestMessage.parse_obj(obj)

        _obj = CreateSessionRequestMessage.parse_obj({
            ...
            "body": CreateSessionRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
