...
class SetPublishingModeRequestMessage(BaseModel):
    """
    ...
    body: SetPublishingModeRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 797):
            raise ValueError("must be one of enum values (0, 797)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetPublishingModeRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetPublishingModeRequestMessage:
        """Create an instance of SetPublishingModeRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetPublishingModeRequestMessage.parse_obj(obj)

        _obj = SetPublishingModeRequestMessage.parse_obj({
            ...
            "body": SetPublishingModeRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
