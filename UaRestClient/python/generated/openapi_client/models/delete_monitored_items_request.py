...
class DeleteMonitoredItemsRequest(BaseModel):
    """
    ...
    __properties = ["RequestHeader", "SubscriptionId", "MonitoredItemIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteMonitoredItemsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteMonitoredItemsRequest:
        """Create an instance of DeleteMonitoredItemsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteMonitoredItemsRequest.parse_obj(obj)

        _obj = DeleteMonitoredItemsRequest.parse_obj({
