...
class CreateMonitoredItemsResponse(BaseModel):
    """
    CreateMonitoredItemsResponse
    """
    response_header: Optional[ResponseHeader] = Field(None, alias="ResponseHeader")
    results: Optional[conlist(MonitoredItemCreateResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMonitoredItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMonitoredItemsResponse:
        """Create an instance of CreateMonitoredItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMonitoredItemsResponse.parse_obj(obj)

        _obj = CreateMonitoredItemsResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [MonitoredItemCreateResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
