...
class RegisterNodesRequest(BaseModel):
    ...
    nodes_to_register: Optional[conlist(StrictStr)] = Field(None, alias="NodesToRegister")
    __properties = ["RequestHeader", "NodesToRegister"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisterNodesRequest:
