...
class ContentFilter(BaseModel):
    ...
    ContentFilter
    """
    elements: Optional[conlist(ContentFilterElement)] = Field(None, alias="Elements")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContentFilter:
        """Create an instance of ContentFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContentFilter.parse_obj(obj)

        _obj = ContentFilter.parse_obj({
            "elements": [ContentFilterElement.from_dict(_item) for _item in obj.get("Elements")] if obj.get("Elements") is not None else None
        })
        return _obj
