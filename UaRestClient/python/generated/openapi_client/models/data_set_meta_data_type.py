...
class DataSetMetaDataType(BaseModel):
    ...
    fields: Optional[conlist(FieldMetaData)] = Field(None, alias="Fields")
    data_set_class_id: Optional[StrictStr] = Field(None, alias="DataSetClassId")
    configuration_version: Optional[ConfigurationVersionDataType] = Field(None, alias="ConfigurationVersion")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataSetMetaDataType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataSetMetaDataType:
        """Create an instance of DataSetMetaDataType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataSetMetaDataType.parse_obj(obj)

        _obj = DataSetMetaDataType.parse_obj({
