...
class SetTriggeringRequestMessage(BaseModel):
    """
    ...
    body: SetTriggeringRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 773):
            raise ValueError("must be one of enum values (0, 773)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetTriggeringRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetTriggeringRequestMessage:
        """Create an instance of SetTriggeringRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetTriggeringRequestMessage.parse_obj(obj)

        _obj = SetTriggeringRequestMessage.parse_obj({
            ...
            "body": SetTriggeringRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
