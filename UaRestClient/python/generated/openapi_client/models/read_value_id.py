...
class ReadValueId(BaseModel):
    ...
    __properties = ["NodeId", "AttributeId", "IndexRange", "DataEncoding"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReadValueId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReadValueId:
        """Create an instance of ReadValueId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReadValueId.parse_obj(obj)

        _obj = ReadValueId.parse_obj({
