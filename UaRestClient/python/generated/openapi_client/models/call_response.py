...
class CallResponse(BaseModel):
    ...
    results: Optional[conlist(CallMethodResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CallResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CallResponse:
        """Create an instance of CallResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CallResponse.parse_obj(obj)

        _obj = CallResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [CallMethodResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
