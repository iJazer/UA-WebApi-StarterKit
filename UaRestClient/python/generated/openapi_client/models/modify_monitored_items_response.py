...
class ModifyMonitoredItemsResponse(BaseModel):
    """
    ModifyMonitoredItemsResponse
    """
    response_header: Optional[ResponseHeader] = Field(None, alias="ResponseHeader")
    results: Optional[conlist(MonitoredItemModifyResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyMonitoredItemsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyMonitoredItemsResponse:
        """Create an instance of ModifyMonitoredItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifyMonitoredItemsResponse.parse_obj(obj)

        _obj = ModifyMonitoredItemsResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [MonitoredItemModifyResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
