...
class ReaderGroupDataType(BaseModel):
    ...
    data_set_readers: Optional[conlist(DataSetReaderDataType)] = Field(None, alias="DataSetReaders")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReaderGroupDataType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReaderGroupDataType:
        """Create an instance of ReaderGroupDataType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReaderGroupDataType.parse_obj(obj)

        _obj = ReaderGroupDataType.parse_obj({
            "name": obj.get("Name"),
