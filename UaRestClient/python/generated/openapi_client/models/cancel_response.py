...
class CancelResponse(BaseModel):
    ...
    cancel_count: Optional[conint(strict=True, le=4294967295, ge=0)] = Field(None, alias="CancelCount")
    __properties = ["ResponseHeader", "CancelCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelResponse:
