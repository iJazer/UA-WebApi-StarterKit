...
class SubscriptionAcknowledgement(BaseModel):
    ...
    __properties = ["SubscriptionId", "SequenceNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionAcknowledgement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionAcknowledgement:
        """Create an instance of SubscriptionAcknowledgement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionAcknowledgement.parse_obj(obj)

        _obj = SubscriptionAcknowledgement.parse_obj({
