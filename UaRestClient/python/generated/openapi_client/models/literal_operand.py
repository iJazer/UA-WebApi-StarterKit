...
class LiteralOperand(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LiteralOperand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LiteralOperand:
        """Create an instance of LiteralOperand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LiteralOperand.parse_obj(obj)

        _obj = LiteralOperand.parse_obj({
        })
        return _obj
