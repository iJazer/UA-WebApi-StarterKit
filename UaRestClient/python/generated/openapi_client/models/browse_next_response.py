...
class BrowseNextResponse(BaseModel):
    """
    BrowseNextResponse
    """
    response_header: Optional[ResponseHeader] = Field(None, alias="ResponseHeader")
    results: Optional[conlist(BrowseResult)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrowseNextResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrowseNextResponse:
        """Create an instance of BrowseNextResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrowseNextResponse.parse_obj(obj)

        _obj = BrowseNextResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [BrowseResult.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
