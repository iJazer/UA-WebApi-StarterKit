...
class ReadResponse(BaseModel):
    ...
    results: Optional[conlist(DataValue)] = Field(None, alias="Results")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReadResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReadResponse:
        """Create an instance of ReadResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReadResponse.parse_obj(obj)

        _obj = ReadResponse.parse_obj({
            "response_header": ResponseHeader.from_dict(obj.get("ResponseHeader")) if obj.get("ResponseHeader") is not None else None,
            "results": [DataValue.from_dict(_item) for _item in obj.get("Results")] if obj.get("Results") is not None else None,
