...
class HistoryUpdateRequestMessage(BaseModel):
    """
    ...
    body: HistoryUpdateRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 698):
            raise ValueError("must be one of enum values (0, 698)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HistoryUpdateRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HistoryUpdateRequestMessage:
        """Create an instance of HistoryUpdateRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HistoryUpdateRequestMessage.parse_obj(obj)

        _obj = HistoryUpdateRequestMessage.parse_obj({
            ...
            "body": HistoryUpdateRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
