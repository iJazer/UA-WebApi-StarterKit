...
class SetMonitoringModeRequestMessage(BaseModel):
    """
    ...
    body: SetMonitoringModeRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 767):
            raise ValueError("must be one of enum values (0, 767)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetMonitoringModeRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetMonitoringModeRequestMessage:
        """Create an instance of SetMonitoringModeRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetMonitoringModeRequestMessage.parse_obj(obj)

        _obj = SetMonitoringModeRequestMessage.parse_obj({
            ...
            "body": SetMonitoringModeRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
