...
class RegisterNodesRequestMessage(BaseModel):
    """
    ...
    body: RegisterNodesRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 558):
            raise ValueError("must be one of enum values (0, 558)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisterNodesRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegisterNodesRequestMessage:
        """Create an instance of RegisterNodesRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegisterNodesRequestMessage.parse_obj(obj)

        _obj = RegisterNodesRequestMessage.parse_obj({
            ...
            "body": RegisterNodesRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
