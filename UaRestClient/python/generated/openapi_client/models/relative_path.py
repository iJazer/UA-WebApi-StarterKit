...
class RelativePath(BaseModel):
    ...
    RelativePath
    """
    elements: Optional[conlist(RelativePathElement)] = Field(None, alias="Elements")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelativePath:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelativePath:
        """Create an instance of RelativePath from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelativePath.parse_obj(obj)

        _obj = RelativePath.parse_obj({
            "elements": [RelativePathElement.from_dict(_item) for _item in obj.get("Elements")] if obj.get("Elements") is not None else None
        })
        return _obj
