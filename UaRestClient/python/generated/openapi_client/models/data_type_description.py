...
class DataTypeDescription(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataTypeDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataTypeDescription:
        """Create an instance of DataTypeDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataTypeDescription.parse_obj(obj)

        _obj = DataTypeDescription.parse_obj({
