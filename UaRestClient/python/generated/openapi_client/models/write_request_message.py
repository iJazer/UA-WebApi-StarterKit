...
class WriteRequestMessage(BaseModel):
    """
    WriteRequestMessage
    """
    ...
    body: WriteRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 671):
            raise ValueError("must be one of enum values (0, 671)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WriteRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WriteRequestMessage:
        """Create an instance of WriteRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WriteRequestMessage.parse_obj(obj)

        _obj = WriteRequestMessage.parse_obj({
            ...
            "body": WriteRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
