...
class BrowseResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrowseResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrowseResponse:
        """Create an instance of BrowseResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrowseResponse.parse_obj(obj)

        _obj = BrowseResponse.parse_obj({
