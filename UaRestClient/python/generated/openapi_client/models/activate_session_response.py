...
class ActivateSessionResponse(BaseModel):
    ...
    __properties = ["ResponseHeader", "ServerNonce", "Results", "DiagnosticInfos"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivateSessionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivateSessionResponse:
        """Create an instance of ActivateSessionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivateSessionResponse.parse_obj(obj)

        _obj = ActivateSessionResponse.parse_obj({
