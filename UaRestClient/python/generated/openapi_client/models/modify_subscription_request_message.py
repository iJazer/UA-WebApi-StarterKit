...
class ModifySubscriptionRequestMessage(BaseModel):
    """
    ...
    body: ModifySubscriptionRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 791):
            raise ValueError("must be one of enum values (0, 791)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifySubscriptionRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifySubscriptionRequestMessage:
        """Create an instance of ModifySubscriptionRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifySubscriptionRequestMessage.parse_obj(obj)

        _obj = ModifySubscriptionRequestMessage.parse_obj({
            ...
            "body": ModifySubscriptionRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
