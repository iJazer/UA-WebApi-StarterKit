...
class SetMonitoringModeResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetMonitoringModeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetMonitoringModeResponse:
        """Create an instance of SetMonitoringModeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetMonitoringModeResponse.parse_obj(obj)

        _obj = SetMonitoringModeResponse.parse_obj({
