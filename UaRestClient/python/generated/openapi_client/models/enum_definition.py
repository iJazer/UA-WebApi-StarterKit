...
class EnumDefinition(BaseModel):
    ...
    EnumDefinition
    """
    fields: Optional[conlist(EnumField)] = Field(None, alias="Fields")
    __properties = []
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnumDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnumDefinition:
        """Create an instance of EnumDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnumDefinition.parse_obj(obj)

        _obj = EnumDefinition.parse_obj({
        })
        return _obj
