...
class RepublishRequest(BaseModel):
    ...
    retransmit_sequence_number: Optional[conint(strict=True, le=4294967295, ge=0)] = Field(None, alias="RetransmitSequenceNumber")
    __properties = ["RequestHeader", "SubscriptionId", "RetransmitSequenceNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepublishRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepublishRequest:
        """Create an instance of RepublishRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepublishRequest.parse_obj(obj)

        _obj = RepublishRequest.parse_obj({
            ...
            "retransmit_sequence_number": obj.get("RetransmitSequenceNumber")
        })
        return _obj
