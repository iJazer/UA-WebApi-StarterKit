...
class UnregisterNodesRequestMessage(BaseModel):
    """
    ...
    body: UnregisterNodesRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 564):
            raise ValueError("must be one of enum values (0, 564)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnregisterNodesRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnregisterNodesRequestMessage:
        """Create an instance of UnregisterNodesRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnregisterNodesRequestMessage.parse_obj(obj)

        _obj = UnregisterNodesRequestMessage.parse_obj({
            ...
            "body": UnregisterNodesRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
