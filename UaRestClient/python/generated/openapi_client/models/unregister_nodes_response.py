...
class UnregisterNodesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnregisterNodesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnregisterNodesResponse:
        """Create an instance of UnregisterNodesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnregisterNodesResponse.parse_obj(obj)

        _obj = UnregisterNodesResponse.parse_obj({
