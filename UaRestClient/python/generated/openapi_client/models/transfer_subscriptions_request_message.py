...
class TransferSubscriptionsRequestMessage(BaseModel):
    """
    ...
    body: TransferSubscriptionsRequest = Field(..., alias="Body")
    ...
    def service_id_validate_enum(cls, value):
        ...
        if value not in (0, 839):
            raise ValueError("must be one of enum values (0, 839)")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferSubscriptionsRequestMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferSubscriptionsRequestMessage:
        """Create an instance of TransferSubscriptionsRequestMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferSubscriptionsRequestMessage.parse_obj(obj)

        _obj = TransferSubscriptionsRequestMessage.parse_obj({
            ...
            "body": TransferSubscriptionsRequest.from_dict(obj.get("Body")) if obj.get("Body") is not None else None
        })
        return _obj
