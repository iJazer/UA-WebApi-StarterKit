...
from openapi_client.models.status_change_notification import StatusChangeNotification  # noqa: E501
    ...
    def make_instance(self, include_optional) -> StatusChangeNotification:
        ...
        if include_optional:
            return StatusChangeNotification(
                status = 0,
                diagnostic_info = openapi_client.models.diagnostic_info.DiagnosticInfo(
                    symbolic_id = 56, 
                    namespace_uri = 56, 
                    locale = 56, 
                    localized_text = 56, 
