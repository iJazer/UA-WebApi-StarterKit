...
from openapi_client.models.find_servers_response_message import FindServersResponseMessage  # noqa: E501

class TestFindServersResponseMessage(unittest.TestCase):
    """FindServersResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindServersResponseMessage:
        """Test FindServersResponseMessage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindServersResponseMessage`
        """
        model = FindServersResponseMessage()  # noqa: E501
        if include_optional:
            return FindServersResponseMessage(
                ...
                service_id = 0,
                body = openapi_client.models.find_servers_response.FindServersResponse(
    ...
    def testFindServersResponseMessage(self):
        """Test FindServersResponseMessage"""
