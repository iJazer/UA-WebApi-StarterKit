...
from openapi_client.models.data_change_notification import DataChangeNotification  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DataChangeNotification:
        ...
        if include_optional:
            return DataChangeNotification(
                monitored_items = [
                    openapi_client.models.monitored_item_notification.MonitoredItemNotification(
                        client_handle = 0, 
