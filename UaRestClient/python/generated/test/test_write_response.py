...
from openapi_client.models.write_response import WriteResponse  # noqa: E501

class TestWriteResponse(unittest.TestCase):
    """WriteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WriteResponse:
        """Test WriteResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WriteResponse`
        """
        model = WriteResponse()  # noqa: E501
        if include_optional:
