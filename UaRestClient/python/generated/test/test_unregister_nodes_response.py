...
from openapi_client.models.unregister_nodes_response import UnregisterNodesResponse  # noqa: E501

class TestUnregisterNodesResponse(unittest.TestCase):
    """UnregisterNodesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnregisterNodesResponse:
        """Test UnregisterNodesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnregisterNodesResponse`
        """
        model = UnregisterNodesResponse()  # noqa: E501
        if include_optional:
    ...
    def testUnregisterNodesResponse(self):
        """Test UnregisterNodesResponse"""
