...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSubscriptionRequestMessage")]
    public partial class CreateSubscriptionRequestMessage : IEquatable<CreateSubscriptionRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSubscriptionRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionRequestMessage" /> class.
        /// </summary>
        ...
        public CreateSubscriptionRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CreateSubscriptionRequest body = default(CreateSubscriptionRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CreateSubscriptionRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public CreateSubscriptionRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSubscriptionRequestMessage {\n");
        ...
        {
            return this.Equals(input as CreateSubscriptionRequestMessage);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubscriptionRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionRequestMessage input)
        {
            if (input == null)
            {
                return false;
