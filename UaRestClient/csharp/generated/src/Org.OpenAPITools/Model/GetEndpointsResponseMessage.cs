...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEndpointsResponseMessage")]
    public partial class GetEndpointsResponseMessage : IEquatable<GetEndpointsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEndpointsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public GetEndpointsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), GetEndpointsResponse body = default(GetEndpointsResponse))
        {
        ...
        public GetEndpointsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEndpointsResponseMessage {\n");
        ...
        {
            return this.Equals(input as GetEndpointsResponseMessage);
        }

        /// <summary>
        /// Returns true if GetEndpointsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEndpointsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEndpointsResponseMessage input)
        {
            if (input == null)
            {
                return false;
