...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FindServersRequestMessage")]
    public partial class FindServersRequestMessage : IEquatable<FindServersRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FindServersRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FindServersRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FindServersRequestMessage" /> class.
        /// </summary>
        ...
        public FindServersRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), FindServersRequest body = default(FindServersRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for FindServersRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public FindServersRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FindServersRequestMessage {\n");
        ...
        {
            return this.Equals(input as FindServersRequestMessage);
        }

        /// <summary>
        /// Returns true if FindServersRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of FindServersRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindServersRequestMessage input)
        {
            if (input == null)
            {
                return false;
