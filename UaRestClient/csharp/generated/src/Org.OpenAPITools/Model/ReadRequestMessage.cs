...
namespace Org.OpenAPITools.Model
{
    ...
    /// ReadRequestMessage
    /// </summary>
    [DataContract(Name = "ReadRequestMessage")]
    public partial class ReadRequestMessage : IEquatable<ReadRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadRequestMessage" /> class.
        /// </summary>
        ...
        public ReadRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ReadRequest body = default(ReadRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for ReadRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public ReadRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadRequestMessage {\n");
        ...
        {
            return this.Equals(input as ReadRequestMessage);
        }

        /// <summary>
        /// Returns true if ReadRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadRequestMessage input)
        {
            if (input == null)
            {
                return false;
