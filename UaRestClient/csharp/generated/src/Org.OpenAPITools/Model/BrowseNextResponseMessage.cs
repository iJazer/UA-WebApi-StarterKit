...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseNextResponseMessage : IEquatable<BrowseNextResponseMessage>, IValidatableObject
    {
        ...
        public BrowseNextResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), BrowseNextResponse body = default(BrowseNextResponse))
        {
