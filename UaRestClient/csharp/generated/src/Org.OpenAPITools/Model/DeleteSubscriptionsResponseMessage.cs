...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteSubscriptionsResponseMessage")]
    public partial class DeleteSubscriptionsResponseMessage : IEquatable<DeleteSubscriptionsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSubscriptionsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public DeleteSubscriptionsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), DeleteSubscriptionsResponse body = default(DeleteSubscriptionsResponse))
        {
        ...
        public DeleteSubscriptionsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteSubscriptionsResponseMessage {\n");
        ...
        {
            return this.Equals(input as DeleteSubscriptionsResponseMessage);
        }

        /// <summary>
        /// Returns true if DeleteSubscriptionsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteSubscriptionsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteSubscriptionsResponseMessage input)
        {
            if (input == null)
            {
                return false;
