...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublishRequestMessage")]
    public partial class PublishRequestMessage : IEquatable<PublishRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublishRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishRequestMessage" /> class.
        /// </summary>
        ...
        public PublishRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), PublishRequest body = default(PublishRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for PublishRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public PublishRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublishRequestMessage {\n");
        ...
        {
            return this.Equals(input as PublishRequestMessage);
        }

        /// <summary>
        /// Returns true if PublishRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of PublishRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublishRequestMessage input)
        {
            if (input == null)
            {
                return false;
