...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CloseSessionResponseMessage")]
    public partial class CloseSessionResponseMessage : IEquatable<CloseSessionResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseSessionResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public CloseSessionResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CloseSessionResponse body = default(CloseSessionResponse))
        {
        ...
        public CloseSessionResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseSessionResponseMessage {\n");
        ...
        {
            return this.Equals(input as CloseSessionResponseMessage);
        }

        /// <summary>
        /// Returns true if CloseSessionResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseSessionResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseSessionResponseMessage input)
        {
            if (input == null)
            {
                return false;
