...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteSubscriptionsRequestMessage")]
    public partial class DeleteSubscriptionsRequestMessage : IEquatable<DeleteSubscriptionsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSubscriptionsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteSubscriptionsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSubscriptionsRequestMessage" /> class.
        /// </summary>
        ...
        public DeleteSubscriptionsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), DeleteSubscriptionsRequest body = default(DeleteSubscriptionsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for DeleteSubscriptionsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public DeleteSubscriptionsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteSubscriptionsRequestMessage {\n");
        ...
        {
            return this.Equals(input as DeleteSubscriptionsRequestMessage);
        }

        /// <summary>
        /// Returns true if DeleteSubscriptionsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteSubscriptionsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteSubscriptionsRequestMessage input)
        {
            if (input == null)
            {
                return false;
