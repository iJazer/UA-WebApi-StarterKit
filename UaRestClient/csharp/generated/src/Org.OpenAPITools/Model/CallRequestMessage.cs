...
namespace Org.OpenAPITools.Model
{
    ...
    /// CallRequestMessage
    /// </summary>
    [DataContract(Name = "CallRequestMessage")]
    public partial class CallRequestMessage : IEquatable<CallRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallRequestMessage" /> class.
        /// </summary>
        ...
        public CallRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CallRequest body = default(CallRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CallRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public CallRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallRequestMessage {\n");
        ...
        {
            return this.Equals(input as CallRequestMessage);
        }

        /// <summary>
        /// Returns true if CallRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CallRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallRequestMessage input)
        {
            if (input == null)
            {
                return false;
