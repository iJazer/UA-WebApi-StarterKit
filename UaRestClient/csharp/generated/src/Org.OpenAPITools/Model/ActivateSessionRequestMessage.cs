...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivateSessionRequestMessage")]
    public partial class ActivateSessionRequestMessage : IEquatable<ActivateSessionRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivateSessionRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActivateSessionRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivateSessionRequestMessage" /> class.
        /// </summary>
        ...
        public ActivateSessionRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ActivateSessionRequest body = default(ActivateSessionRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for ActivateSessionRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public ActivateSessionRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivateSessionRequestMessage {\n");
        ...
        {
            return this.Equals(input as ActivateSessionRequestMessage);
        }

        /// <summary>
        /// Returns true if ActivateSessionRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivateSessionRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivateSessionRequestMessage input)
        {
            if (input == null)
            {
                return false;
