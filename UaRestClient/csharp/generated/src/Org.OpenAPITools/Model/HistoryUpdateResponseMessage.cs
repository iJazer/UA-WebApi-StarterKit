...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoryUpdateResponseMessage")]
    public partial class HistoryUpdateResponseMessage : IEquatable<HistoryUpdateResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryUpdateResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public HistoryUpdateResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), HistoryUpdateResponse body = default(HistoryUpdateResponse))
        {
        ...
        public HistoryUpdateResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HistoryUpdateResponseMessage {\n");
        ...
        {
            return this.Equals(input as HistoryUpdateResponseMessage);
        }

        /// <summary>
        /// Returns true if HistoryUpdateResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryUpdateResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryUpdateResponseMessage input)
        {
            if (input == null)
            {
                return false;
