...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModifySubscriptionResponseMessage")]
    public partial class ModifySubscriptionResponseMessage : IEquatable<ModifySubscriptionResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifySubscriptionResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public ModifySubscriptionResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ModifySubscriptionResponse body = default(ModifySubscriptionResponse))
        {
        ...
        public ModifySubscriptionResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifySubscriptionResponseMessage {\n");
        ...
        {
            return this.Equals(input as ModifySubscriptionResponseMessage);
        }

        /// <summary>
        /// Returns true if ModifySubscriptionResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifySubscriptionResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifySubscriptionResponseMessage input)
        {
            if (input == null)
            {
                return false;
