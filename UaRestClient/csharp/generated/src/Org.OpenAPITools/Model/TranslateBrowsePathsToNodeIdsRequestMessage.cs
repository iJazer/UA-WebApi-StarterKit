...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslateBrowsePathsToNodeIdsRequestMessage")]
    public partial class TranslateBrowsePathsToNodeIdsRequestMessage : IEquatable<TranslateBrowsePathsToNodeIdsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateBrowsePathsToNodeIdsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslateBrowsePathsToNodeIdsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateBrowsePathsToNodeIdsRequestMessage" /> class.
        /// </summary>
        ...
        public TranslateBrowsePathsToNodeIdsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), TranslateBrowsePathsToNodeIdsRequest body = default(TranslateBrowsePathsToNodeIdsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for TranslateBrowsePathsToNodeIdsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public TranslateBrowsePathsToNodeIdsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateBrowsePathsToNodeIdsRequestMessage {\n");
        ...
        {
            return this.Equals(input as TranslateBrowsePathsToNodeIdsRequestMessage);
        }

        /// <summary>
        /// Returns true if TranslateBrowsePathsToNodeIdsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateBrowsePathsToNodeIdsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateBrowsePathsToNodeIdsRequestMessage input)
        {
            if (input == null)
            {
                return false;
