...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CancelResponseMessage")]
    public partial class CancelResponseMessage : IEquatable<CancelResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public CancelResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CancelResponse body = default(CancelResponse))
        {
        ...
        public CancelResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelResponseMessage {\n");
        ...
        {
            return this.Equals(input as CancelResponseMessage);
        }

        /// <summary>
        /// Returns true if CancelResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelResponseMessage input)
        {
            if (input == null)
            {
                return false;
