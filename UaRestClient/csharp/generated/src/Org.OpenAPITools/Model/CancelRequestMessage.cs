...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CancelRequestMessage")]
    public partial class CancelRequestMessage : IEquatable<CancelRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CancelRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelRequestMessage" /> class.
        /// </summary>
        ...
        public CancelRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CancelRequest body = default(CancelRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CancelRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelRequestMessage {\n");
        ...
        {
            return this.Equals(input as CancelRequestMessage);
        }

        /// <summary>
        /// Returns true if CancelRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelRequestMessage input)
        {
            if (input == null)
            {
                return false;
