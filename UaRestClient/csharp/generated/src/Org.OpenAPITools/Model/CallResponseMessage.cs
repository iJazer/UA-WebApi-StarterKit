...
namespace Org.OpenAPITools.Model
{
    ...
    /// CallResponseMessage
    /// </summary>
    [DataContract(Name = "CallResponseMessage")]
    public partial class CallResponseMessage : IEquatable<CallResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public CallResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CallResponse body = default(CallResponse))
        {
        ...
        public CallResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallResponseMessage {\n");
        ...
        {
            return this.Equals(input as CallResponseMessage);
        }

        /// <summary>
        /// Returns true if CallResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CallResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallResponseMessage input)
        {
            if (input == null)
            {
                return false;
