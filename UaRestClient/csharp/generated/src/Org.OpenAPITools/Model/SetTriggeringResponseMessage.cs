...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetTriggeringResponseMessage")]
    public partial class SetTriggeringResponseMessage : IEquatable<SetTriggeringResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetTriggeringResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public SetTriggeringResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), SetTriggeringResponse body = default(SetTriggeringResponse))
        {
        ...
        public SetTriggeringResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetTriggeringResponseMessage {\n");
        ...
        {
            return this.Equals(input as SetTriggeringResponseMessage);
        }

        /// <summary>
        /// Returns true if SetTriggeringResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SetTriggeringResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetTriggeringResponseMessage input)
        {
            if (input == null)
            {
                return false;
