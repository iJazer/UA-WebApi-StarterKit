...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WriteResponseMessage")]
    public partial class WriteResponseMessage : IEquatable<WriteResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public WriteResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), WriteResponse body = default(WriteResponse))
        {
        ...
        public WriteResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteResponseMessage {\n");
        ...
        {
            return this.Equals(input as WriteResponseMessage);
        }

        /// <summary>
        /// Returns true if WriteResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteResponseMessage input)
        {
            if (input == null)
            {
                return false;
