...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnregisterNodesRequestMessage")]
    public partial class UnregisterNodesRequestMessage : IEquatable<UnregisterNodesRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterNodesRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnregisterNodesRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterNodesRequestMessage" /> class.
        /// </summary>
        ...
        public UnregisterNodesRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), UnregisterNodesRequest body = default(UnregisterNodesRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for UnregisterNodesRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public UnregisterNodesRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnregisterNodesRequestMessage {\n");
        ...
        {
            return this.Equals(input as UnregisterNodesRequestMessage);
        }

        /// <summary>
        /// Returns true if UnregisterNodesRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of UnregisterNodesRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnregisterNodesRequestMessage input)
        {
            if (input == null)
            {
                return false;
