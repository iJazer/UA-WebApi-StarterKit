...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DeleteMonitoredItemsResponse : IEquatable<DeleteMonitoredItemsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMonitoredItemsResponse" /> class.
        /// </summary>
        /// <param name="responseHeader">responseHeader.</param>
        /// <param name="results">results.</param>
        /// <param name="diagnosticInfos">diagnosticInfos.</param>
        public DeleteMonitoredItemsResponse(ResponseHeader responseHeader = default(ResponseHeader), List<long> results = default(List<long>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMonitoredItemsResponse {\n");
        ...
        {
            return this.Equals(input as DeleteMonitoredItemsResponse);
        }

        /// <summary>
        /// Returns true if DeleteMonitoredItemsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteMonitoredItemsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteMonitoredItemsResponse input)
        {
            if (input == null)
            {
                return false;
