...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RepublishRequestMessage")]
    public partial class RepublishRequestMessage : IEquatable<RepublishRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepublishRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RepublishRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RepublishRequestMessage" /> class.
        /// </summary>
        ...
        public RepublishRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), RepublishRequest body = default(RepublishRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for RepublishRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public RepublishRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RepublishRequestMessage {\n");
        ...
        {
            return this.Equals(input as RepublishRequestMessage);
        }

        /// <summary>
        /// Returns true if RepublishRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of RepublishRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RepublishRequestMessage input)
        {
            if (input == null)
            {
                return false;
