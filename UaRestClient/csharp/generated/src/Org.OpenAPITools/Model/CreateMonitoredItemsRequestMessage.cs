...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateMonitoredItemsRequestMessage")]
    public partial class CreateMonitoredItemsRequestMessage : IEquatable<CreateMonitoredItemsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMonitoredItemsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateMonitoredItemsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMonitoredItemsRequestMessage" /> class.
        /// </summary>
        ...
        public CreateMonitoredItemsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CreateMonitoredItemsRequest body = default(CreateMonitoredItemsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CreateMonitoredItemsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public CreateMonitoredItemsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMonitoredItemsRequestMessage {\n");
        ...
        {
            return this.Equals(input as CreateMonitoredItemsRequestMessage);
        }

        /// <summary>
        /// Returns true if CreateMonitoredItemsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateMonitoredItemsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMonitoredItemsRequestMessage input)
        {
            if (input == null)
            {
                return false;
