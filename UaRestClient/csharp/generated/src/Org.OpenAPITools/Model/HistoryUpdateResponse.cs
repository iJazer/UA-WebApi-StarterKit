...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoryUpdateResponse")]
    public partial class HistoryUpdateResponse : IEquatable<HistoryUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryUpdateResponse" /> class.
        /// </summary>
        /// <param name="responseHeader">responseHeader.</param>
        /// <param name="results">results.</param>
        /// <param name="diagnosticInfos">diagnosticInfos.</param>
        public HistoryUpdateResponse(ResponseHeader responseHeader = default(ResponseHeader), List<HistoryUpdateResult> results = default(List<HistoryUpdateResult>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        public List<HistoryUpdateResult> Results { get; set; }
        ...
        {
            return this.Equals(input as HistoryUpdateResponse);
        }

        /// <summary>
        /// Returns true if HistoryUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryUpdateResponse input)
        {
            if (input == null)
            {
                return false;
