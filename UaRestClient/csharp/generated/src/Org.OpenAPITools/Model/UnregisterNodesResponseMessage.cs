...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnregisterNodesResponseMessage")]
    public partial class UnregisterNodesResponseMessage : IEquatable<UnregisterNodesResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnregisterNodesResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public UnregisterNodesResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), UnregisterNodesResponse body = default(UnregisterNodesResponse))
        {
        ...
        public UnregisterNodesResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnregisterNodesResponseMessage {\n");
        ...
        {
            return this.Equals(input as UnregisterNodesResponseMessage);
        }

        /// <summary>
        /// Returns true if UnregisterNodesResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of UnregisterNodesResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnregisterNodesResponseMessage input)
        {
            if (input == null)
            {
                return false;
