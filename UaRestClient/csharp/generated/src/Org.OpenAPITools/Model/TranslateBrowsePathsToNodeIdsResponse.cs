...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TranslateBrowsePathsToNodeIdsResponse : IEquatable<TranslateBrowsePathsToNodeIdsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateBrowsePathsToNodeIdsResponse" /> class.
        /// </summary>
        ...
        public List<BrowsePathResult> Results { get; set; }
        ...
        {
            return this.Equals(input as TranslateBrowsePathsToNodeIdsResponse);
        }

        /// <summary>
        /// Returns true if TranslateBrowsePathsToNodeIdsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateBrowsePathsToNodeIdsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateBrowsePathsToNodeIdsResponse input)
        {
            if (input == null)
            {
                return false;
