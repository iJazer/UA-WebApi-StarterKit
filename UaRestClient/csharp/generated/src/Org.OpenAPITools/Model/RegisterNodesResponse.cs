...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RegisterNodesResponse : IEquatable<RegisterNodesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RegisterNodesResponse);
        }

        /// <summary>
        /// Returns true if RegisterNodesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterNodesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterNodesResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RegisteredNodeIds == input.RegisteredNodeIds ||
                    this.RegisteredNodeIds != null &&
                    input.RegisteredNodeIds != null &&
                    this.RegisteredNodeIds.SequenceEqual(input.RegisteredNodeIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RegisteredNodeIds.GetHashCode();
                }
                return hashCode;
            }
        }
