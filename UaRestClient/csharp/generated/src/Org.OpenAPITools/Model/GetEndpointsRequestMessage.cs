...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEndpointsRequestMessage")]
    public partial class GetEndpointsRequestMessage : IEquatable<GetEndpointsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEndpointsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEndpointsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEndpointsRequestMessage" /> class.
        /// </summary>
        ...
        public GetEndpointsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), GetEndpointsRequest body = default(GetEndpointsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for GetEndpointsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public GetEndpointsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEndpointsRequestMessage {\n");
        ...
        {
            return this.Equals(input as GetEndpointsRequestMessage);
        }

        /// <summary>
        /// Returns true if GetEndpointsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEndpointsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEndpointsRequestMessage input)
        {
            if (input == null)
            {
                return false;
