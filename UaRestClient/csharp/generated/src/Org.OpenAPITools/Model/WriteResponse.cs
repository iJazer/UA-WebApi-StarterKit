...
namespace Org.OpenAPITools.Model
{
    ...
    /// WriteResponse
    /// </summary>
    [DataContract(Name = "WriteResponse")]
    public partial class WriteResponse : IEquatable<WriteResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteResponse" /> class.
        /// </summary>
        /// <param name="responseHeader">responseHeader.</param>
        /// <param name="results">results.</param>
        /// <param name="diagnosticInfos">diagnosticInfos.</param>
        public WriteResponse(ResponseHeader responseHeader = default(ResponseHeader), List<long> results = default(List<long>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        {
            return this.Equals(input as WriteResponse);
        }

        /// <summary>
        /// Returns true if WriteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteResponse input)
        {
            if (input == null)
            {
                return false;
