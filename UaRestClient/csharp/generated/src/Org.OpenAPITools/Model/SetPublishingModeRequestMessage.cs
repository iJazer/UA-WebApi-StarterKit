...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetPublishingModeRequestMessage")]
    public partial class SetPublishingModeRequestMessage : IEquatable<SetPublishingModeRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPublishingModeRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetPublishingModeRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPublishingModeRequestMessage" /> class.
        /// </summary>
        ...
        public SetPublishingModeRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), SetPublishingModeRequest body = default(SetPublishingModeRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for SetPublishingModeRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public SetPublishingModeRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetPublishingModeRequestMessage {\n");
        ...
        {
            return this.Equals(input as SetPublishingModeRequestMessage);
        }

        /// <summary>
        /// Returns true if SetPublishingModeRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SetPublishingModeRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetPublishingModeRequestMessage input)
        {
            if (input == null)
            {
                return false;
