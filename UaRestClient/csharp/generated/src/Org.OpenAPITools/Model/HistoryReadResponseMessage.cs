...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoryReadResponseMessage")]
    public partial class HistoryReadResponseMessage : IEquatable<HistoryReadResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryReadResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public HistoryReadResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), HistoryReadResponse body = default(HistoryReadResponse))
        {
        ...
        public HistoryReadResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HistoryReadResponseMessage {\n");
        ...
        {
            return this.Equals(input as HistoryReadResponseMessage);
        }

        /// <summary>
        /// Returns true if HistoryReadResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryReadResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryReadResponseMessage input)
        {
            if (input == null)
            {
                return false;
