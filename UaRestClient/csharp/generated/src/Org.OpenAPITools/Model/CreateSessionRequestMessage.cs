...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSessionRequestMessage")]
    public partial class CreateSessionRequestMessage : IEquatable<CreateSessionRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSessionRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSessionRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSessionRequestMessage" /> class.
        /// </summary>
        ...
        public CreateSessionRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CreateSessionRequest body = default(CreateSessionRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CreateSessionRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public CreateSessionRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSessionRequestMessage {\n");
        ...
        {
            return this.Equals(input as CreateSessionRequestMessage);
        }

        /// <summary>
        /// Returns true if CreateSessionRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSessionRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSessionRequestMessage input)
        {
            if (input == null)
            {
                return false;
