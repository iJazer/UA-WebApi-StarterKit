...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ReadResponse : IEquatable<ReadResponse>, IValidatableObject
    {
        ...
        public ReadResponse(ResponseHeader responseHeader = default(ResponseHeader), List<DataValue> results = default(List<DataValue>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
