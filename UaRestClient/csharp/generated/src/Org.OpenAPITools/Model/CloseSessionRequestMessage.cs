...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CloseSessionRequestMessage")]
    public partial class CloseSessionRequestMessage : IEquatable<CloseSessionRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseSessionRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CloseSessionRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseSessionRequestMessage" /> class.
        /// </summary>
        ...
        public CloseSessionRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CloseSessionRequest body = default(CloseSessionRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CloseSessionRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public CloseSessionRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloseSessionRequestMessage {\n");
        ...
        {
            return this.Equals(input as CloseSessionRequestMessage);
        }

        /// <summary>
        /// Returns true if CloseSessionRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CloseSessionRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloseSessionRequestMessage input)
        {
            if (input == null)
            {
                return false;
