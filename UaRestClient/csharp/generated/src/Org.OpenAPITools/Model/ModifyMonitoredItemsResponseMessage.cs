...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModifyMonitoredItemsResponseMessage")]
    public partial class ModifyMonitoredItemsResponseMessage : IEquatable<ModifyMonitoredItemsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyMonitoredItemsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public ModifyMonitoredItemsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ModifyMonitoredItemsResponse body = default(ModifyMonitoredItemsResponse))
        {
        ...
        public ModifyMonitoredItemsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyMonitoredItemsResponseMessage {\n");
        ...
        {
            return this.Equals(input as ModifyMonitoredItemsResponseMessage);
        }

        /// <summary>
        /// Returns true if ModifyMonitoredItemsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyMonitoredItemsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyMonitoredItemsResponseMessage input)
        {
            if (input == null)
            {
                return false;
