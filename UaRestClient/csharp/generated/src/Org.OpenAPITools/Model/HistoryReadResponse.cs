...
namespace Org.OpenAPITools.Model
{
    ...
    /// HistoryReadResponse
    /// </summary>
    [DataContract(Name = "HistoryReadResponse")]
    public partial class HistoryReadResponse : IEquatable<HistoryReadResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryReadResponse" /> class.
        /// </summary>
        /// <param name="responseHeader">responseHeader.</param>
        /// <param name="results">results.</param>
        /// <param name="diagnosticInfos">diagnosticInfos.</param>
        public HistoryReadResponse(ResponseHeader responseHeader = default(ResponseHeader), List<HistoryReadResult> results = default(List<HistoryReadResult>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        {
            return this.Equals(input as HistoryReadResponse);
        }

        /// <summary>
        /// Returns true if HistoryReadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryReadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryReadResponse input)
        {
            if (input == null)
            {
                return false;
