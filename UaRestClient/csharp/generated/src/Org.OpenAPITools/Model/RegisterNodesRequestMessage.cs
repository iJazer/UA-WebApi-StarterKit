...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegisterNodesRequestMessage")]
    public partial class RegisterNodesRequestMessage : IEquatable<RegisterNodesRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterNodesRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RegisterNodesRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterNodesRequestMessage" /> class.
        /// </summary>
        ...
        public RegisterNodesRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), RegisterNodesRequest body = default(RegisterNodesRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for RegisterNodesRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public RegisterNodesRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegisterNodesRequestMessage {\n");
        ...
        {
            return this.Equals(input as RegisterNodesRequestMessage);
        }

        /// <summary>
        /// Returns true if RegisterNodesRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterNodesRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterNodesRequestMessage input)
        {
            if (input == null)
            {
                return false;
