...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RegisterNodesResponseMessage")]
    public partial class RegisterNodesResponseMessage : IEquatable<RegisterNodesResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterNodesResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public RegisterNodesResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), RegisterNodesResponse body = default(RegisterNodesResponse))
        {
        ...
        public RegisterNodesResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegisterNodesResponseMessage {\n");
        ...
        {
            return this.Equals(input as RegisterNodesResponseMessage);
        }

        /// <summary>
        /// Returns true if RegisterNodesResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterNodesResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterNodesResponseMessage input)
        {
            if (input == null)
            {
                return false;
