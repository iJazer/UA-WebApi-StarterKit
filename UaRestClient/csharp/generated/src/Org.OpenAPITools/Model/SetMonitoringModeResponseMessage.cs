...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetMonitoringModeResponseMessage")]
    public partial class SetMonitoringModeResponseMessage : IEquatable<SetMonitoringModeResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetMonitoringModeResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public SetMonitoringModeResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), SetMonitoringModeResponse body = default(SetMonitoringModeResponse))
        {
        ...
        public SetMonitoringModeResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetMonitoringModeResponseMessage {\n");
        ...
        {
            return this.Equals(input as SetMonitoringModeResponseMessage);
        }

        /// <summary>
        /// Returns true if SetMonitoringModeResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SetMonitoringModeResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetMonitoringModeResponseMessage input)
        {
            if (input == null)
            {
                return false;
