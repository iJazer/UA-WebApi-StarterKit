...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetPublishingModeResponseMessage")]
    public partial class SetPublishingModeResponseMessage : IEquatable<SetPublishingModeResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetPublishingModeResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public SetPublishingModeResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), SetPublishingModeResponse body = default(SetPublishingModeResponse))
        {
        ...
        public SetPublishingModeResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetPublishingModeResponseMessage {\n");
        ...
        {
            return this.Equals(input as SetPublishingModeResponseMessage);
        }

        /// <summary>
        /// Returns true if SetPublishingModeResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SetPublishingModeResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetPublishingModeResponseMessage input)
        {
            if (input == null)
            {
                return false;
