...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RepublishResponseMessage")]
    public partial class RepublishResponseMessage : IEquatable<RepublishResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepublishResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public RepublishResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), RepublishResponse body = default(RepublishResponse))
        {
        ...
        public RepublishResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RepublishResponseMessage {\n");
        ...
        {
            return this.Equals(input as RepublishResponseMessage);
        }

        /// <summary>
        /// Returns true if RepublishResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of RepublishResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RepublishResponseMessage input)
        {
            if (input == null)
            {
                return false;
