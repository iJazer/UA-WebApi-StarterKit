...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteMonitoredItemsResponseMessage")]
    public partial class DeleteMonitoredItemsResponseMessage : IEquatable<DeleteMonitoredItemsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMonitoredItemsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public DeleteMonitoredItemsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), DeleteMonitoredItemsResponse body = default(DeleteMonitoredItemsResponse))
        {
        ...
        public DeleteMonitoredItemsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMonitoredItemsResponseMessage {\n");
        ...
        {
            return this.Equals(input as DeleteMonitoredItemsResponseMessage);
        }

        /// <summary>
        /// Returns true if DeleteMonitoredItemsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteMonitoredItemsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteMonitoredItemsResponseMessage input)
        {
            if (input == null)
            {
                return false;
