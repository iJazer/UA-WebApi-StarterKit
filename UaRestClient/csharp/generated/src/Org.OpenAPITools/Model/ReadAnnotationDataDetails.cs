...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReadAnnotationDataDetails")]
    public partial class ReadAnnotationDataDetails : IEquatable<ReadAnnotationDataDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ReadAnnotationDataDetails);
        }

        /// <summary>
        /// Returns true if ReadAnnotationDataDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadAnnotationDataDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadAnnotationDataDetails input)
        {
            if (input == null)
            {
                return false;
