...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoryReadRequestMessage")]
    public partial class HistoryReadRequestMessage : IEquatable<HistoryReadRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryReadRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HistoryReadRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoryReadRequestMessage" /> class.
        /// </summary>
        ...
        public HistoryReadRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), HistoryReadRequest body = default(HistoryReadRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for HistoryReadRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public HistoryReadRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HistoryReadRequestMessage {\n");
        ...
        {
            return this.Equals(input as HistoryReadRequestMessage);
        }

        /// <summary>
        /// Returns true if HistoryReadRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoryReadRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoryReadRequestMessage input)
        {
            if (input == null)
            {
                return false;
