...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetEndpointsRequest : IEquatable<GetEndpointsRequest>, IValidatableObject
    {
        ...
        public GetEndpointsRequest(RequestHeader requestHeader = default(RequestHeader), string endpointUrl = default(string), List<string> localeIds = default(List<string>), List<string> profileUris = default(List<string>))
        {
