...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SetMonitoringModeResponse : IEquatable<SetMonitoringModeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public SetMonitoringModeResponse(ResponseHeader responseHeader = default(ResponseHeader), List<long> results = default(List<long>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        {
            return this.Equals(input as SetMonitoringModeResponse);
        }

        /// <summary>
        /// Returns true if SetMonitoringModeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SetMonitoringModeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetMonitoringModeResponse input)
        {
            if (input == null)
            {
                return false;
