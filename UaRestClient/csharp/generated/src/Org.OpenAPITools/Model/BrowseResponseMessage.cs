...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BrowseResponseMessage")]
    public partial class BrowseResponseMessage : IEquatable<BrowseResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BrowseResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public BrowseResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), BrowseResponse body = default(BrowseResponse))
        {
        ...
        public BrowseResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrowseResponseMessage {\n");
        ...
        {
            return this.Equals(input as BrowseResponseMessage);
        }

        /// <summary>
        /// Returns true if BrowseResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of BrowseResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrowseResponseMessage input)
        {
            if (input == null)
            {
                return false;
