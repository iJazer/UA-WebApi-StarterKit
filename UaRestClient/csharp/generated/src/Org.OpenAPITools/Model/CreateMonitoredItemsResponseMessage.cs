...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateMonitoredItemsResponseMessage")]
    public partial class CreateMonitoredItemsResponseMessage : IEquatable<CreateMonitoredItemsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMonitoredItemsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public CreateMonitoredItemsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CreateMonitoredItemsResponse body = default(CreateMonitoredItemsResponse))
        {
        ...
        public CreateMonitoredItemsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMonitoredItemsResponseMessage {\n");
        ...
        {
            return this.Equals(input as CreateMonitoredItemsResponseMessage);
        }

        /// <summary>
        /// Returns true if CreateMonitoredItemsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateMonitoredItemsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMonitoredItemsResponseMessage input)
        {
            if (input == null)
            {
                return false;
