...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSessionResponseMessage")]
    public partial class CreateSessionResponseMessage : IEquatable<CreateSessionResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSessionResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public CreateSessionResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), CreateSessionResponse body = default(CreateSessionResponse))
        {
        ...
        public CreateSessionResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSessionResponseMessage {\n");
        ...
        {
            return this.Equals(input as CreateSessionResponseMessage);
        }

        /// <summary>
        /// Returns true if CreateSessionResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSessionResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSessionResponseMessage input)
        {
            if (input == null)
            {
                return false;
