...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferSubscriptionsRequestMessage")]
    public partial class TransferSubscriptionsRequestMessage : IEquatable<TransferSubscriptionsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSubscriptionsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferSubscriptionsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSubscriptionsRequestMessage" /> class.
        /// </summary>
        ...
        public TransferSubscriptionsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), TransferSubscriptionsRequest body = default(TransferSubscriptionsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for TransferSubscriptionsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public TransferSubscriptionsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferSubscriptionsRequestMessage {\n");
        ...
        {
            return this.Equals(input as TransferSubscriptionsRequestMessage);
        }

        /// <summary>
        /// Returns true if TransferSubscriptionsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferSubscriptionsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferSubscriptionsRequestMessage input)
        {
            if (input == null)
            {
                return false;
