...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteMonitoredItemsRequestMessage")]
    public partial class DeleteMonitoredItemsRequestMessage : IEquatable<DeleteMonitoredItemsRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMonitoredItemsRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteMonitoredItemsRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMonitoredItemsRequestMessage" /> class.
        /// </summary>
        ...
        public DeleteMonitoredItemsRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), DeleteMonitoredItemsRequest body = default(DeleteMonitoredItemsRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for DeleteMonitoredItemsRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public DeleteMonitoredItemsRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteMonitoredItemsRequestMessage {\n");
        ...
        {
            return this.Equals(input as DeleteMonitoredItemsRequestMessage);
        }

        /// <summary>
        /// Returns true if DeleteMonitoredItemsRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteMonitoredItemsRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteMonitoredItemsRequestMessage input)
        {
            if (input == null)
            {
                return false;
