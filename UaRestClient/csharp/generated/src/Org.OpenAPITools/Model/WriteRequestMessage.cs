...
namespace Org.OpenAPITools.Model
{
    ...
    /// WriteRequestMessage
    /// </summary>
    [DataContract(Name = "WriteRequestMessage")]
    public partial class WriteRequestMessage : IEquatable<WriteRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteRequestMessage" /> class.
        /// </summary>
        ...
        public WriteRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), WriteRequest body = default(WriteRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for WriteRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public WriteRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteRequestMessage {\n");
        ...
        {
            return this.Equals(input as WriteRequestMessage);
        }

        /// <summary>
        /// Returns true if WriteRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteRequestMessage input)
        {
            if (input == null)
            {
                return false;
