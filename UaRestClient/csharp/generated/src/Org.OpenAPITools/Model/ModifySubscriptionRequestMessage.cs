...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModifySubscriptionRequestMessage")]
    public partial class ModifySubscriptionRequestMessage : IEquatable<ModifySubscriptionRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifySubscriptionRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifySubscriptionRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifySubscriptionRequestMessage" /> class.
        /// </summary>
        ...
        public ModifySubscriptionRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ModifySubscriptionRequest body = default(ModifySubscriptionRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for ModifySubscriptionRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public ModifySubscriptionRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifySubscriptionRequestMessage {\n");
        ...
        {
            return this.Equals(input as ModifySubscriptionRequestMessage);
        }

        /// <summary>
        /// Returns true if ModifySubscriptionRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifySubscriptionRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifySubscriptionRequestMessage input)
        {
            if (input == null)
            {
                return false;
