...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferSubscriptionsResponseMessage")]
    public partial class TransferSubscriptionsResponseMessage : IEquatable<TransferSubscriptionsResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSubscriptionsResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public TransferSubscriptionsResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), TransferSubscriptionsResponse body = default(TransferSubscriptionsResponse))
        {
        ...
        public TransferSubscriptionsResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferSubscriptionsResponseMessage {\n");
        ...
        {
            return this.Equals(input as TransferSubscriptionsResponseMessage);
        }

        /// <summary>
        /// Returns true if TransferSubscriptionsResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferSubscriptionsResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferSubscriptionsResponseMessage input)
        {
            if (input == null)
            {
                return false;
