...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublishResponseMessage")]
    public partial class PublishResponseMessage : IEquatable<PublishResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public PublishResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), PublishResponse body = default(PublishResponse))
        {
        ...
        public PublishResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublishResponseMessage {\n");
        ...
        {
            return this.Equals(input as PublishResponseMessage);
        }

        /// <summary>
        /// Returns true if PublishResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of PublishResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublishResponseMessage input)
        {
            if (input == null)
            {
                return false;
