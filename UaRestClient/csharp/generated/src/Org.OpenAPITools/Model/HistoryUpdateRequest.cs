...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class HistoryUpdateRequest : IEquatable<HistoryUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="historyUpdateDetails">historyUpdateDetails.</param>
        public HistoryUpdateRequest(RequestHeader requestHeader = default(RequestHeader), List<ExtensionObject> historyUpdateDetails = default(List<ExtensionObject>))
        {
        ...
        /// <summary>
        /// Gets or Sets HistoryUpdateDetails
        /// </summary>
        [DataMember(Name = "HistoryUpdateDetails", EmitDefaultValue = false)]
        public List<ExtensionObject> HistoryUpdateDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HistoryUpdateDetails: ").Append(HistoryUpdateDetails).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
