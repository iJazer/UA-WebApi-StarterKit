...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseNextRequestMessage : IEquatable<BrowseNextRequestMessage>, IValidatableObject
    {
        ...
        protected BrowseNextRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrowseNextRequestMessage" /> class.
        /// </summary>
        ...
        public BrowseNextRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), BrowseNextRequest body = default(BrowseNextRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for BrowseNextRequestMessage and cannot be null");
            }
            this.Body = body;
