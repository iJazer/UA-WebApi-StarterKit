...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivateSessionResponseMessage")]
    public partial class ActivateSessionResponseMessage : IEquatable<ActivateSessionResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivateSessionResponseMessage" /> class.
        /// </summary>
        /// <param name="namespaceUris">namespaceUris.</param>
        /// <param name="serverUris">serverUris.</param>
        /// <param name="serviceId">serviceId.</param>
        /// <param name="body">body.</param>
        public ActivateSessionResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), ActivateSessionResponse body = default(ActivateSessionResponse))
        {
        ...
        public ActivateSessionResponse Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivateSessionResponseMessage {\n");
        ...
        {
            return this.Equals(input as ActivateSessionResponseMessage);
        }

        /// <summary>
        /// Returns true if ActivateSessionResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivateSessionResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivateSessionResponseMessage input)
        {
            if (input == null)
            {
                return false;
