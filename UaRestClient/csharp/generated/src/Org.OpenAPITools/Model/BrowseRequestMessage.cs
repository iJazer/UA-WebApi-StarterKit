...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BrowseRequestMessage")]
    public partial class BrowseRequestMessage : IEquatable<BrowseRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BrowseRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BrowseRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrowseRequestMessage" /> class.
        /// </summary>
        ...
        public BrowseRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), BrowseRequest body = default(BrowseRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for BrowseRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public BrowseRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrowseRequestMessage {\n");
        ...
        {
            return this.Equals(input as BrowseRequestMessage);
        }

        /// <summary>
        /// Returns true if BrowseRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of BrowseRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrowseRequestMessage input)
        {
            if (input == null)
            {
                return false;
