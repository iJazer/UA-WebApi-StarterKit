...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SetMonitoringModeRequestMessage")]
    public partial class SetMonitoringModeRequestMessage : IEquatable<SetMonitoringModeRequestMessage>, IValidatableObject
    {
        /// <summary>
        /// Defines ServiceId
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetMonitoringModeRequestMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetMonitoringModeRequestMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetMonitoringModeRequestMessage" /> class.
        /// </summary>
        ...
        public SetMonitoringModeRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), ServiceIdEnum? serviceId = default(ServiceIdEnum?), SetMonitoringModeRequest body = default(SetMonitoringModeRequest))
        {
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for SetMonitoringModeRequestMessage and cannot be null");
            }
            this.Body = body;
        ...
        public SetMonitoringModeRequest Body { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetMonitoringModeRequestMessage {\n");
        ...
        {
            return this.Equals(input as SetMonitoringModeRequestMessage);
        }

        /// <summary>
        /// Returns true if SetMonitoringModeRequestMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of SetMonitoringModeRequestMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetMonitoringModeRequestMessage input)
        {
            if (input == null)
            {
                return false;
