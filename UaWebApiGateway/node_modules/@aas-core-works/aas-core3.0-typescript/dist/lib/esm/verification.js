 ...
 */
export function matchesIdShort(text) {
 ...
 */
export function matchesVersionType(text) {
 ...
 */
export function matchesRevisionType(text) {
 ...
 */
export function matchesXsDateTimeUtc(text) {
 ...
 */
export function isXsDateTimeUtc(value) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesMimeType(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesRfc8089Path(text) {
 ...
 */
export function matchesBcp47(text) {
 ...
 */
export function langStringsHaveUniqueLanguages(langStrings) {
 ...
 * @returns `true` if the check passes
 */
export function qualifierTypesAreUnique(qualifiers) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXmlSerializableString(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsAnyUri(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsBase64Binary(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsBoolean(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsDate(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsDateTime(text) {
 ...
 */
export function isXsDateTime(value) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsDecimal(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsDouble(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsDuration(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsFloat(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsGDay(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsGMonth(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsGMonthDay(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsGYear(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsGYearMonth(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsHexBinary(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsTime(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsInteger(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsLong(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsInt(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsShort(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsByte(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsNonNegativeInteger(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsPositiveInteger(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsUnsignedLong(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsUnsignedInt(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsUnsignedShort(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsUnsignedByte(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsNonPositiveInteger(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsNegativeInteger(text) {
 ...
 * @returns True if the `text` conforms to the pattern
 */
export function matchesXsString(text) {
...
const DAYS_IN_MONTH = new Map([[1, 31],
 ...
 */
export function isXsDate(value) {
  // NOTE (mristin, 2022-11-23):
  // We can not use date functions from the standard library as it does not
  // handle years BCE (*e.g.*, `-0003-01-02`).
 ...
 */
export function isXsDouble(value) {
  // NOTE (mristin, 2022-11-23):
 ...
 */
export function isXsFloat(value) {
  // NOTE (mristin, 2022-11-23):
  // We need to check explicitly for the regular expression since
  // `parseFloat` expects `Infinity`  instead of `INF`.
 ...
 */
export function isXsGMonthDay(value) {
 ...
 */
export function isXsLong(value) {
  // NOTE (mristin, 2022-11-23):
 ...
 */
export function isXsShort(value) {
 ...
 */
export function isXsByte(value) {
 ...
 */
export function isXsUnsignedLong(value) {
  // NOTE (mristin, 2022-11-23):
  // We need to operate on the value as string since TypeScript represents numbers as
  // 64-bit floating-point numbers which can not capture 64-bit integers.
 ...
 */
export function isXsUnsignedInt(value) {
 ...
 */
export function isXsUnsignedShort(value) {
 ...
 */
export function isXsUnsignedByte(value) {
...
function assertAllDataTypeDefXsdCovered() {
  for (const literal of AasTypes.overDataTypeDefXsd()) {
    if (!DATA_TYPE_DEF_XSD_TO_VALUE_CONSISTENCY.has(literal)) {
      throw new Error(`The enumeration key ${literal} of AasTypes.DataTypeDefXsd ` + "is not covered in DATA_TYPE_DEF_XSD_TO_VALUE_CONSISTENCY");
    }
  }
}
 ...
 */
export function valueConsistentWithXsdType(value, valueType) {
 ...
 */
export function isModelReferenceTo(reference, expectedType) {
 ...
 */
export function isModelReferenceToReferable(reference) {
 ...
 * @returns `true` if the check passes
 */
export function idShortsAreUnique(referables) {
  const idShortSet = new Set();
 ...
 * @returns `true` if the check passes
 */
export function idShortsOfVariablesAreUnique(inputVariables, outputVariables, inoutputVariables) {
  const idShortSet = new Set();
 ...
 * @returns `true` if the check passes
 */
export function extensionNamesAreUnique(extensions) {
 ...
 */
export function submodelElementsHaveIdenticalSemanticIds(elements) {
  let thatSemanticId = null;
...
function assertAllTypesCoveredInAasSubmodelElementsToIs() {
  for (const literal of AasTypes.overAasSubmodelElements()) {
    if (!AAS_SUBMODEL_ELEMENTS_TO_IS.has(literal)) {
      throw new Error(`The enumeration literal ${literal} of AasTypes.AasSubmodelElements ` + "is not covered in AAS_SUBMODEL_ELEMENTS_TO_IS");
    }
  }
}
 ...
 */
export function submodelElementIsOfType(element, expectedType) {
 ...
 * @returns `true` if the check passes
 */
export function propertiesOrRangesHaveValueType(elements, valueType) {
  for (const element of elements) {
 ...
 */
export function referenceKeyValuesEqual(that, other) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sForPropertyOrValueHaveAppropriateDataType(embeddedDataSpecifications) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sForReferenceHaveAppropriateDataType(embeddedDataSpecifications) {
  for (const embeddedDataSpecification of embeddedDataSpecifications) {
    const content = embeddedDataSpecification.dataSpecificationContent;
    if (AasTypes.isDataSpecificationIec61360(content)) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sForDocumentHaveAppropriateDataType(embeddedDataSpecifications) {
  for (const embeddedDataSpecification of embeddedDataSpecifications) {
    const content = embeddedDataSpecification.dataSpecificationContent;
    if (AasTypes.isDataSpecificationIec61360(content)) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sHaveDataType(embeddedDataSpecifications) {
  for (const embeddedDataSpecification of embeddedDataSpecifications) {
    const content = embeddedDataSpecification.dataSpecificationContent;
    if (AasTypes.isDataSpecificationIec61360(content)) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sHaveValue(embeddedDataSpecifications) {
  for (const embeddedDataSpecification of embeddedDataSpecifications) {
    const content = embeddedDataSpecification.dataSpecificationContent;
    if (AasTypes.isDataSpecificationIec61360(content)) {
 ...
 * @returns `true` if the check passes
 */
export function dataSpecificationIec61360sHaveDefinitionAtLeastInEnglish(embeddedDataSpecifications) {
  for (const embeddedDataSpecification of embeddedDataSpecifications) {
    const content = embeddedDataSpecification.dataSpecificationContent;
    if (AasTypes.isDataSpecificationIec61360(content)) {
 ...
 */
export function isBcp47ForEnglish(text) {
...
class Verifier extends AasTypes.AbstractTransformerWithContext {
  *transformExtensionWithContext(that, context) {
    if (!(!(that.supplementalSemanticIds !== null) || that.supplementalSemanticIds.length >= 1)) {
      yield new VerificationError("Supplemental semantic IDs must be either not set or have at " + "least one item.");
    }
    if (!(!(that.supplementalSemanticIds !== null) || that.semanticId !== null)) {
      yield new VerificationError("Constraint AASd-118: If there are supplemental semantic IDs " + "defined then there shall be also a main semantic ID.");
    }
      ...
      if (that.supplementalSemanticIds !== null) {
        ...
        for (const item of that.supplementalSemanticIds) {
          for (const error of this.transformWithContext(item, context)) {
            error.path.prepend(new IndexSegment(that.supplementalSemanticIds, supplementalSemanticIdsIndex));
  ...
  *transformAdministrativeInformationWithContext(that, context) {
    if (!(!(that.embeddedDataSpecifications !== null) || that.embeddedDataSpecifications.length >= 1)) {
      yield new VerificationError("Embedded data specifications must be either not set or have " + "at least one item.");
    }
    if (!(!(that.revision !== null) || that.version !== null)) {
      yield new VerificationError("Constraint AASd-005: If version is not specified then also " + "revision shall be unspecified. This means, a revision " + "requires a version. If there is no version there is no " + "revision either. Revision is optional.");
    }
    ...
    if (context === true) {
      if (that.embeddedDataSpecifications !== null) {
        ...
        for (const item of that.embeddedDataSpecifications) {
          for (const error of this.transformWithContext(item, context)) {
            error.path.prepend(new IndexSegment(that.embeddedDataSpecifications, embeddedDataSpecificationsIndex));
  ...
  *transformQualifierWithContext(that, context) {
    if (!(!(that.supplementalSemanticIds !== null) || that.supplementalSemanticIds.length >= 1)) {
      yield new VerificationError("Supplemental semantic IDs must be either not set or have at " + "least one item.");
    }
    if (!(!(that.supplementalSemanticIds !== null) || that.semanticId !== null)) {
    ...
    if (!(!(that.value !== null) || valueConsistentWithXsdType(that.value, that.valueType))) {
      yield new VerificationError("Constraint AASd-020: The value shall be consistent to " + "the data type as defined in value type.");
    }
  ...
  *transformAssetAdministrationShellWithContext(that, context) {
    ...
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
      yield new VerificationError("Constraint AASd-077: The name of an extension within " + "Has-Extensions needs to be unique.");
    }
    ...
    if (!(!(that.derivedFrom !== null) || isModelReferenceTo(that.derivedFrom, AasTypes.KeyTypes.AssetAdministrationShell))) {
      yield new VerificationError("Derived-from must be a model reference to an asset " + "administration shell.");
    }
    if (!(!(that.submodels !== null) || AasCommon.every(AasCommon.map(that.submodels, reference => isModelReferenceTo(reference, AasTypes.KeyTypes.Submodel))))) {
  ...
  *transformAssetInformationWithContext(that, context) {
    if (!(!(that.specificAssetIds !== null) || AasCommon.every(AasCommon.map(that.specificAssetIds, specificAssetId => specificAssetId.name != "globalAssetId" || that.globalAssetId !== null && specificAssetId.name == "globalAssetId" && specificAssetId.value == that.globalAssetId)))) {
      yield new VerificationError("Constraint AASd-116: ``globalAssetId`` is a reserved key. " + "If used as value for the name of specific asset ID then " + "the value of specific asset ID shall be identical to " + "the global asset ID.");
    }
    if (!((that.globalAssetId !== null || that.specificAssetIds !== null) && (!(that.specificAssetIds !== null) || that.specificAssetIds.length >= 1))) {
      yield new VerificationError("Constraint AASd-131: Either the global asset ID shall be " + "defined or at least one specific asset ID.");
    }
  ...
  *transformResourceWithContext(that,
  ...
  *transformSpecificAssetIdWithContext(that, context) {
    if (!(!(that.supplementalSemanticIds !== null) || that.supplementalSemanticIds.length >= 1)) {
      yield new VerificationError("Supplemental semantic IDs must be either not set or have at " + "least one item.");
    }
    if (!(!(that.supplementalSemanticIds !== null) || that.semanticId !== null)) {
    ...
    if (!(!(that.externalSubjectId !== null) || that.externalSubjectId.type == AasTypes.ReferenceTypes.ExternalReference)) {
      yield new VerificationError("Constraint AASd-133: External subject ID shall be " + "an external reference.");
    }
  ...
  *transformSubmodelWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.qualifiers !== null) || qualifierTypesAreUnique(that.qualifiers))) {
      yield new VerificationError("Constraint AASd-021: Every qualifiable can only have one " + "qualifier with the same type.");
    }
    if (!(!(that.embeddedDataSpecifications !== null) || that.embeddedDataSpecifications.length >= 1)) {
      yield new VerificationError("Embedded data specifications must be either not set or have " + "at least one item.");
    }
    ...
    if (!(!(that.submodelElements !== null) || AasCommon.every(AasCommon.map(that.submodelElements, item => item.idShort !== null)))) {
      yield new VerificationError("ID-shorts need to be defined for all the items of submodel " + "elements according to AASd-117 (ID-short of Referables not " + "being a direct child of a Submodel element list shall be " + "specified).");
    }
    if (!(!(that.submodelElements !== null) || idShortsAreUnique(that.submodelElements))) {
      yield new VerificationError("Constraint AASd-022: ID-short of non-identifiable " + "referables within the same name space shall be unique " + "(case-sensitive).");
    }
    if (!(!(that.submodelElements !== null) || !(that.kindOrDefault() != AasTypes.ModellingKind.Template) || AasCommon.every(AasCommon.map(that.submodelElements, submodelElement => !(submodelElement.qualifiers !== null) || AasCommon.every(AasCommon.map(submodelElement.qualifiers, qualifier => qualifier.kindOrDefault() != AasTypes.QualifierKind.TemplateQualifier)))))) {
      yield new VerificationError("Constraint AASd-129: If any qualifier kind value of " + "a Submodel element qualifier (attribute qualifier inherited " + "via Qualifiable) is equal to Template Qualifier then " + "the submodel element shall be part of a submodel template, " + "i.e. a Submodel with submodel kind (attribute kind " + "inherited via Has-Kind) value is equal to Template.");
    }
    if (!(!(that.qualifiers !== null) || !AasCommon.some(AasCommon.map(that.qualifiers, qualifier => qualifier.kindOrDefault() == AasTypes.QualifierKind.TemplateQualifier)) || that.kindOrDefault() == AasTypes.ModellingKind.Template)) {
      yield new VerificationError("Constraint AASd-119: If any qualifier kind value of " + "a qualifiable qualifier is equal to template qualifier and " + "the qualified element has kind then the qualified element " + "shall be of kind template.");
    }
    if (that.category !== null) {
      for (const error of verifyNameType(that.category)) {
        error.path.prepend(new PropertySegment(that, "category"));
  ...
  *transformRelationshipElementWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformSubmodelElementListWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.value !== null && that.semanticIdListElement !== null) || AasCommon.every(AasCommon.map(that.value, child => !(child.semanticId !== null) || referenceKeyValuesEqual(child.semanticId, that.semanticIdListElement))))) {
      yield new VerificationError("Constraint AASd-107: If a first level child element has " + "a semantic ID it shall be identical to semantic ID list " + "element.");
    }
    if (!(!(that.value !== null) || submodelElementsHaveIdenticalSemanticIds(that.value))) {
      yield new VerificationError("Constraint AASd-114: If two first level child elements have " + "a semantic ID then they shall be identical.");
    }
    if (!(!(that.value !== null) || AasCommon.every(AasCommon.map(that.value, element => submodelElementIsOfType(element, that.typeValueListElement))))) {
      yield new VerificationError("Constraint AASd-108: All first level child elements shall " + "have the same submodel element type as specified in type " + "value list element.");
    }
    if (!(!(that.value !== null && (that.typeValueListElement == AasTypes.AasSubmodelElements.Property || that.typeValueListElement == AasTypes.AasSubmodelElements.Range)) || that.valueTypeListElement !== null && propertiesOrRangesHaveValueType(that.value, that.valueTypeListElement))) {
      yield new VerificationError("Constraint AASd-109: If type value list element is equal to " + "Property or Range value type list element shall be set and " + "all first level child elements shall have the value type as " + "specified in value type list element.");
    }
    if (!(!(that.value !== null) || AasCommon.every(AasCommon.map(that.value, element => element.idShort === null)))) {
      yield new VerificationError("Constraint AASd-120: ID-short of submodel elements being " + "a direct child of a  Submodel element list shall not be " + "specified.");
    }
    if (that.category !== null) {
      for (const error of verifyNameType(that.category)) {
        error.path.prepend(new PropertySegment(that, "category"));
  ...
  *transformSubmodelElementCollectionWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.value !== null) || AasCommon.every(AasCommon.map(that.value, item => item.idShort !== null)))) {
      yield new VerificationError("ID-shorts need to be defined for all the items of value " + "according to AASd-117 (ID-short of Referables not being " + "a direct child of a Submodel element list shall be " + "specified).");
    }
  ...
  *transformPropertyWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.category !== null) || AasConstants.VALID_CATEGORIES_FOR_DATA_ELEMENT.has(that.category))) {
      yield new VerificationError("Constraint AASd-090: For data elements category shall be " + "one of the following values: CONSTANT, PARAMETER or " + "VARIABLE.");
    }
    if (!(!(that.value !== null) || valueConsistentWithXsdType(that.value, that.valueType))) {
  ...
  *transformMultiLanguagePropertyWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformRangeWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformReferenceElementWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformBlobWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformFileWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformAnnotatedRelationshipElementWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.annotations !== null) || AasCommon.every(AasCommon.map(that.annotations, item => item.idShort !== null)))) {
      yield new VerificationError("ID-shorts need to be defined for all the items of " + "annotations according to AASd-117 (ID-short of Referables " + "not being a direct child of a Submodel element list shall " + "be specified).");
    }
    if (that.category !== null) {
      for (const error of verifyNameType(that.category)) {
        error.path.prepend(new PropertySegment(that, "category"));
  ...
  *transformEntityWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.statements !== null) || AasCommon.every(AasCommon.map(that.statements, item => item.idShort !== null)))) {
      yield new VerificationError("ID-shorts need to be defined for all the items of " + "statements according to AASd-117 (ID-short of Referables " + "not being a direct child of a Submodel element list shall " + "be specified).");
    }
    if (!(that.entityType == AasTypes.EntityType.SelfManagedEntity && (that.globalAssetId !== null && that.specificAssetIds === null || that.globalAssetId === null && that.specificAssetIds !== null && that.specificAssetIds.length >= 1) || that.entityType != AasTypes.EntityType.SelfManagedEntity && that.globalAssetId === null && that.specificAssetIds === null)) {
      yield new VerificationError("Constraint AASd-014: Either the attribute global asset ID " + "or specific asset ID must be set if entity type is set to " + "self-managed entity. They are not existing otherwise.");
    }
    if (!(!(that.specificAssetIds !== null) || that.specificAssetIds.length >= 1)) {
      yield new VerificationError("Specific asset IDs must be either not set or have at least " + "one item.");
    }
  ...
  *transformEventPayloadWithContext(that, context) {
  ...
  *transformBasicEventElementWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformOperationWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!idShortsOfVariablesAreUnique(that.inputVariables, that.outputVariables, that.inoutputVariables)) {
      yield new VerificationError("Constraint AASd-134: For an Operation the ID-short of all " + "values of input, output and in/output variables.");
    }
  ...
  *transformOperationVariableWithContext(that, context) {
    if (!(that.value.idShort !== null)) {
      yield new VerificationError("Value must have the ID-short specified according to " + "Constraint AASd-117 (ID-short of Referables not being " + "a direct child of a Submodel element list shall be " + "specified).");
    }
    if (context === true) {
      for (const error of this.transformWithContext(that.value, context)) {
        error.path.prepend(new PropertySegment(that, "value"));
  ...
  *transformCapabilityWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
  ...
  *transformConceptDescriptionWithContext(that, context) {
    if (!(!(that.extensions !== null) || that.extensions.length >= 1)) {
      yield new VerificationError("Extensions must be either not set or have at least one item.");
    }
    if (!(!(that.extensions !== null) || extensionNamesAreUnique(that.extensions))) {
    ...
    if (!(!(that.embeddedDataSpecifications !== null) || dataSpecificationIec61360sHaveDefinitionAtLeastInEnglish(that.embeddedDataSpecifications) || dataSpecificationIec61360sHaveValue(that.embeddedDataSpecifications))) {
      yield new VerificationError("Constraint AASc-3a-008: For a concept description using " + "data specification template IEC 61360, the definition is " + "mandatory and shall be defined at least in English. " + "Exception: The concept description describes a value.");
    }
    if (!(!(that.category !== null && that.category == "QUALIFIER_TYPE" && that.embeddedDataSpecifications !== null) || dataSpecificationIec61360sHaveDataType(that.embeddedDataSpecifications))) {
      yield new VerificationError("Constraint AASc-3a-007: For a concept description with " + "category QUALIFIER_TYPE using data specification IEC 61360, " + "the data type of the data specification is mandatory and " + "shall be defined.");
    }
    if (!(!(that.category !== null && that.category == "DOCUMENT" && that.embeddedDataSpecifications !== null) || dataSpecificationIec61360sForDocumentHaveAppropriateDataType(that.embeddedDataSpecifications))) {
      yield new VerificationError("Constraint AASc-3a-006: For a concept description with " + "category DOCUMENT using data specification IEC 61360, " + "the data type of the data specification shall be one of: " + "FILE, BLOB, HTML.");
    }
    if (!(!(that.category !== null && that.category == "REFERENCE" && that.embeddedDataSpecifications !== null) || dataSpecificationIec61360sForReferenceHaveAppropriateDataType(that.embeddedDataSpecifications))) {
      yield new VerificationError("Constraint AASc-3a-005: For a concept description with " + "category REFERENCE using data specification IEC 61360, " + "the data type of the data specification shall be one of: " + "STRING, IRI, IRDI.");
    }
  ...
  *transformReferenceWithContext(that, context) {
    ...
    if (!(!(that.keys.length >= 1) || AasConstants.GLOBALLY_IDENTIFIABLES.has(AasCommon.at(that.keys, 0).type))) {
      yield new VerificationError("Constraint AASd-121: For References the value of type of " + "the first key of keys shall be one of Globally " + "Identifiables.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ExternalReference && that.keys.length >= 1) || AasConstants.GENERIC_GLOBALLY_IDENTIFIABLES.has(AasCommon.at(that.keys, 0).type))) {
      yield new VerificationError("Constraint AASd-122: For external references the value of " + "type of the first key of keys shall be one of Generic " + "Globally Identifiables.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ModelReference && that.keys.length >= 1) || AasConstants.AAS_IDENTIFIABLES.has(AasCommon.at(that.keys, 0).type))) {
      yield new VerificationError("Constraint AASd-123: For model references the value of type " + "of the first key of keys shall be one of AAS identifiables.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ExternalReference && that.keys.length >= 1) || AasConstants.GENERIC_GLOBALLY_IDENTIFIABLES.has(AasCommon.at(that.keys, -1).type) || AasConstants.GENERIC_FRAGMENT_KEYS.has(AasCommon.at(that.keys, -1).type))) {
      yield new VerificationError("Constraint AASd-124: For external references the last key " + "of keys shall be either one of Generic Globally " + "Identifiables or one of Generic Fragment Keys.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ModelReference && that.keys.length > 1) || AasCommon.every(AasCommon.map(AasCommon.range(1, that.keys.length), i => AasConstants.FRAGMENT_KEYS.has(AasCommon.at(that.keys, i).type))))) {
      yield new VerificationError("Constraint AASd-125: For model references with more than " + "one key in keys the value of type of each of the keys " + "following the first key of keys shall be one of Fragment " + "Keys.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ModelReference && that.keys.length > 1) || AasCommon.every(AasCommon.map(AasCommon.range(0, that.keys.length - 1), i => !AasConstants.GENERIC_FRAGMENT_KEYS.has(AasCommon.at(that.keys, i).type))))) {
      yield new VerificationError("Constraint AASd-126: For model references with more than " + "one key in keys the value of type of the last key in " + "the reference key chain may be one of Generic Fragment Keys " + "or no key at all shall have a value out of Generic Fragment " + "Keys.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ModelReference && that.keys.length > 1 && AasCommon.at(that.keys, -1).type == AasTypes.KeyTypes.FragmentReference) || AasCommon.at(that.keys, -2).type == AasTypes.KeyTypes.File || AasCommon.at(that.keys, -2).type == AasTypes.KeyTypes.Blob)) {
      yield new VerificationError("Constraint AASd-127: For model references, with more than " + "one key in keys a key with type Fragment Reference shall be " + "preceded by a key with type File or Blob.");
    }
    if (!(!(that.type == AasTypes.ReferenceTypes.ModelReference && that.keys.length > 2) || AasCommon.every(AasCommon.map(AasCommon.range(0, that.keys.length - 1), i => !(AasCommon.at(that.keys, i).type == AasTypes.KeyTypes.SubmodelElementList) || matchesXsPositiveInteger(AasCommon.at(that.keys, i + 1).value))))) {
      yield new VerificationError("Constraint AASd-128: For model references, the value of " + "a key preceded by a key with type Submodel element list is " + "an integer number denoting the position in the array of " + "the submodel element list.");
    }
    if (context === true) {
  ...
  *transformLangStringNameTypeWithContext(that,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  context) {
  ...
  *transformLangStringTextTypeWithContext(that,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  context) {
  ...
  *transformEnvironmentWithContext(that, context) {
    ...
    if (!(!(that.assetAdministrationShells !== null) || that.assetAdministrationShells.length >= 1)) {
      yield new VerificationError("Asset administration shells must be either not set or have " + "at least one item.");
    }
    if (context === true) {
  ...
  *transformEmbeddedDataSpecificationWithContext(that, context) {
    if (context === true) {
  ...
  *transformValueReferencePairWithContext(that, context) {
  ...
  *transformValueListWithContext(that, context) {
  ...
  *transformLangStringPreferredNameTypeIec61360WithContext(that,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  context) {
  ...
  *transformLangStringShortNameTypeIec61360WithContext(that,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  context) {
  ...
  *transformLangStringDefinitionTypeIec61360WithContext(that,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  context) {
    if (!(that.text.length <= 1023)) {
      yield new VerificationError("String shall have a maximum length of 1023 characters.");
  ...
  *transformDataSpecificationIec61360WithContext(that, context) {
    if (!!(that.value !== null && that.valueList !== null)) {
      yield new VerificationError("Constraint AASc-3a-010: If value is not empty then value " + "list shall be empty and vice versa.");
    }
    if (!(!(that.dataType !== null && AasConstants.IEC_61360_DATA_TYPES_WITH_UNIT.has(that.dataType)) || that.unit !== null || that.unitId !== null)) {
      yield new VerificationError("Constraint AASc-3a-009: If data type is a an integer, real " + "or rational with a measure or currency, unit or unit ID " + "shall be defined.");
    }
    ...
    if (!AasCommon.some(AasCommon.map(that.preferredName, langString => isBcp47ForEnglish(langString.language)))) {
      yield new VerificationError("Constraint AASc-002: preferred name shall be provided at " + "least in English.");
    }
    if (that.unit !== null) {
 ...
 */
export function* verify(that, recurse = true) {
 ...
 */
export function* verifyNonEmptyXmlSerializableString(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyDateTimeUtc(that) {
  if (!matchesXsDateTimeUtc(that)) {
    yield new VerificationError("The value must match the pattern of xs:dateTime with " + "the time zone fixed to UTC.");
  }
  if (!isXsDateTimeUtc(that)) {
    yield new VerificationError("The value must represent a valid xs:dateTime with the time " + "zone fixed to UTC.");
  }
}
 ...
 * @returns errors, if any
 */
export function* verifyDuration(that) {
 ...
 * @returns errors, if any
 */
export function* verifyIdentifier(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyValueTypeIec61360(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyNameType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyVersionType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyRevisionType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyLabelType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyMessageTopicType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyBcp47LanguageTag(that) {
 ...
 * @returns errors, if any
 */
export function* verifyContentType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyPathType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
  ...
  if (!matchesRfc8089Path(that)) {
    yield new VerificationError("The value must represent a valid file URI scheme according " + "to RFC 8089.");
  }
}
 ...
 * @returns errors, if any
 */
export function* verifyQualifierType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
 ...
 * @returns errors, if any
 */
export function* verifyIdShortType(that) {
  if (!matchesXmlSerializableString(that)) {
    yield new VerificationError("Constraint AASd-130: An attribute with data type 'string' " + "shall consist of these characters only: " + "^[\\x09\\x0A\\x0D\\x20-\\uD7FF\\uE000-\\uFFFD\\U00010000-\\U0010FFFF]*$.");
  }
  if (!(that.length >= 1)) {
  ...
  if (!matchesIdShort(that)) {
    yield new VerificationError("ID-short of Referables shall only feature letters, digits, " + "underscore (``_``); starting mandatory with a letter. " + "*I.e.* ``[a-zA-Z][a-zA-Z0-9_]*``.");
  }
}
