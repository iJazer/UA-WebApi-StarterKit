...
return 30;// EmbeddedDataSpecification
   ...
   *
   * @returns Iterator over the referenced instances
   */*descendOnce(){yield this.dataSpecificationContent;if(this.dataSpecification!==null){yield this.dataSpecification;}}/**
   * Iterate recursively over the instances referenced from this instance.
   *
   * @returns Iterator over the referenced instances
   */*descend(){yield this.dataSpecificationContent;yield*this.dataSpecificationContent.descend();if(this.dataSpecification!==null){yield this.dataSpecification;yield*this.dataSpecification.descend();}}/**
   * Dispatch `visitor` on this instance.
   *
   * @param visitor - to visit this instance
