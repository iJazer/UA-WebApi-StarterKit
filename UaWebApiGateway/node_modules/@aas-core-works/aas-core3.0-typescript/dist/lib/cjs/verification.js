...
function constructMatchesRfc8089Path() {
  ...
  var ipv6address = "((".concat(h16, ":){6}").concat(ls32, "|::(").concat(h16, ":){5}").concat(ls32, "|(").concat(h16, ")?::(").concat(h16, ":){4}").concat(ls32, "|((").concat(h16, ":)?").concat(h16, ")?::(").concat(h16, ":){3}").concat(ls32, "|((").concat(h16, ":){0,2}").concat(h16, ")?::(").concat(h16, ":){2}").concat(ls32, "|((").concat(h16, ":){0,3}").concat(h16, ")?::").concat(h16, ":").concat(ls32, "|((").concat(h16, ":){0,4}").concat(h16, ")?::").concat(ls32, "|((").concat(h16, ":){0,5}").concat(h16, ")?::").concat(h16, "|((").concat(h16, ":){0,6}").concat(h16, ")?::)");
...
var Verifier = /*#__PURE__*/function (_AasTypes$AbstractTra) {
  ...
  _createClass(Verifier, [{
    ...
    value: /*#__PURE__*/_regeneratorRuntime().mark(function transformEmbeddedDataSpecificationWithContext(that, context) {
      var _iterator373, _step373, _error205, _iterator374, _step374, error;
      return _regeneratorRuntime().wrap(function transformEmbeddedDataSpecificationWithContext$(_context31) {
        while (1) switch (_context31.prev = _context31.next) {
          case 0:
            ...
            _iterator373 = _createForOfIteratorHelper(this.transformWithContext(that.dataSpecificationContent, context));
            _context31.prev = 2;
            _iterator373.s();
          case 4:
          ...
          case 19:
            ...
            _iterator374 = _createForOfIteratorHelper(this.transformWithContext(that.dataSpecification, context));
            _context31.prev = 21;
            _iterator374.s();
          case 23:
          ...
          case 32:
            _context31.prev = 32;
            _context31.t1 = _context31["catch"](21);
            _iterator374.e(_context31.t1);
          case 35:
            _context31.prev = 35;
            _iterator374.f();
            return _context31.finish(35);
          case 38:
          case "end":
            return _context31.stop();
        }
      }, transformEmbeddedDataSpecificationWithContext, this, [[2, 13, 16, 19], [21, 32, 35, 38]]);
    })
  }, {
