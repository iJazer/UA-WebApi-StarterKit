...
interface CompanionSpecProps {
    // Define any props if needed
}

export const CompanionSpec: React.FC<CompanionSpecProps> = () => {
   ...
   return (
       <TableContainer component={Paper} elevation={3} sx={{ height: '100%', width: '100%' }}>
           <Table>
               <TableHead>
                   <TableRow>
                       <TableCell><Typography variant='h6'>Companion Specification</Typography></TableCell>
                   </TableRow>
               </TableHead>
               <TableBody>
                   <TableRow
                       ...
                       <TableCell sx={{ width: 'auto' }}>
                           <Typography variant='body1' sx={{ minWidth: '300px' }}>Test</Typography>
                       </TableCell>
                   </TableRow> 
               </TableBody>
           </Table>
