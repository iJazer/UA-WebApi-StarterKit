...
namespace I4AAS_Gateway.Server
{
    public class AASServer
    {
        ...
        private AASServerManager m_server;
        ...
        public Opc.Ua.Client.ISession InternalClient => m_client?.Session;
        ...
        public async Task Start(ILogger logger, CancellationToken stoppingToken)
        {
            ...
            m_client = await UAClient.Run(logger, ServerEndpoints, stoppingToken).ConfigureAwait(false);
        }
