...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseRequest : IEquatable<BrowseRequest>, IValidatableObject
    {
        ...
        public BrowseRequest(RequestHeader requestHeader = default(RequestHeader), ViewDescription view = default(ViewDescription), int? requestedMaxReferencesPerNode = null, List<BrowseDescription> nodesToBrowse = default(List<BrowseDescription>))
        {
        ...
        public int? RequestedMaxReferencesPerNode { get; set; }
