...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseRequestMessage : IEquatable<BrowseRequestMessage>, IValidatableObject
    {
        ...
        public BrowseRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), int? serviceId = null, BrowseRequest body = default(BrowseRequest))
        {
