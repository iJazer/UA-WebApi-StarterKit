...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WriteRequestMessage : IEquatable<WriteRequestMessage>, IValidatableObject
    {
        ...
        public WriteRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), int? serviceId = null, WriteRequest body = default(WriteRequest))
        {
