...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseNextResponse : IEquatable<BrowseNextResponse>, IValidatableObject
    {
        ...
        public BrowseNextResponse(ResponseHeader responseHeader = default(ResponseHeader), List<BrowseResult> results = default(List<BrowseResult>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrowseNextResponse {\n");
