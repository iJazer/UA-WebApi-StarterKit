...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BrowseResponseMessage : IEquatable<BrowseResponseMessage>, IValidatableObject
    {
        ...
        public BrowseResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), int? serviceId = null, BrowseResponse body = default(BrowseResponse))
        {
