...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ReadRequestMessage : IEquatable<ReadRequestMessage>, IValidatableObject
    {
        ...
        public ReadRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), int? serviceId = null, ReadRequest body = default(ReadRequest))
        {
