...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CallResponseMessage : IEquatable<CallResponseMessage>, IValidatableObject
    {
        ...
        public CallResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), int? serviceId = null, CallResponse body = default(CallResponse))
        {
