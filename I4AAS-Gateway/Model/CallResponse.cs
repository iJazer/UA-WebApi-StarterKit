...
namespace Org.OpenAPITools.Model
{
    ...
    /// CallResponse
    /// </summary>
    [DataContract(Name = "CallResponse")]
    public partial class CallResponse : IEquatable<CallResponse>, IValidatableObject
    {
        ...
        public CallResponse(ResponseHeader responseHeader = default(ResponseHeader), List<CallMethodResult> results = default(List<CallMethodResult>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
        ...
        public List<CallMethodResult> Results { get; set; }
