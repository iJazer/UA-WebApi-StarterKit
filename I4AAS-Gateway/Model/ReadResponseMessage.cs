...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ReadResponseMessage : IEquatable<ReadResponseMessage>, IValidatableObject
    {
        ...
        public ReadResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), int? serviceId = null, ReadResponse body = default(ReadResponse))
        {
