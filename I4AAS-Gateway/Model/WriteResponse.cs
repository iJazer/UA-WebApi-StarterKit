...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WriteResponse : IEquatable<WriteResponse>, IValidatableObject
    {
        ...
        public WriteResponse(ResponseHeader responseHeader = default(ResponseHeader), List<int> results = default(List<int>), List<DiagnosticInfo> diagnosticInfos = default(List<DiagnosticInfo>))
        {
