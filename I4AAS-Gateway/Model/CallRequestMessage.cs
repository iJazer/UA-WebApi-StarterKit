...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CallRequestMessage : IEquatable<CallRequestMessage>, IValidatableObject
    {
        ...
        public CallRequestMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), List<string> localeIds = default(List<string>), int? serviceId = null, CallRequest body = default(CallRequest))
        {
