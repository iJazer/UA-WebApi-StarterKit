...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WriteResponseMessage : IEquatable<WriteResponseMessage>, IValidatableObject
    {
        ...
        public WriteResponseMessage(List<string> namespaceUris = default(List<string>), List<string> serverUris = default(List<string>), int? serviceId = null, WriteResponse body = default(WriteResponse))
        {
