...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DiagnosticInfo : IEquatable<DiagnosticInfo>, IValidatableObject
    {
        ...
        public DiagnosticInfo(int? symbolicId = null, int? namespaceUri = null, int? locale = null, int? localizedText = null, string additionalInfo = default(string), int? innerStatusCode = null, DiagnosticInfo innerDiagnosticInfo = default(DiagnosticInfo))
        {
