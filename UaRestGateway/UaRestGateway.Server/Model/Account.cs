    ...
    public class UserInfo
    {
        ...
        public static MembershipType GetMembershipType(int? membershipType)
        {
            switch (membershipType ?? 0)
            {
                ...
                case 2:
                case 3:
                case 4: return UaRestGateway.Server.Model.MembershipType.Corporate;
                case 5: return UaRestGateway.Server.Model.MembershipType.EndUser;
                case 6: return UaRestGateway.Server.Model.MembershipType.NonVoting;
                case 7: return UaRestGateway.Server.Model.MembershipType.Logo;
                default: return UaRestGateway.Server.Model.MembershipType.NonMember;
            }
        }
    }
}
